...
namespace DB
{
  namespace VoteImagesLocal
  {
    ...
    public static partial class VoteImagesLocalDb
    {
      ...
      static VoteImagesLocalDb()
      {
        ...
        if (string.IsNullOrWhiteSpace(connectionString))
          connectionString = WebConfigurationManager.AppSettings["CnVoteImagesLocal.MySql"];
        if (!string.IsNullOrWhiteSpace(connectionString))
    ...
    public partial class PoliticiansImagesDataRow : DataRow
    {
      ...
      {
        get { return (DateTime) this["RefreshDate"]; }
        set { this["RefreshDate"] = value; }
      }
    }
    ...
    public partial class PoliticiansImagesDataTable : TypedTableBase<PoliticiansImagesDataRow>
    {
      ...
      public PoliticiansImagesDataRow NewRow(String politicianKey, DateTime profileOriginalDate, DateTime headshotDate, DateTime headshotResizeDate, DateTime refreshDate)
      {
      ...
      public void AddRow(String politicianKey, DateTime profileOriginalDate, DateTime headshotDate, DateTime headshotResizeDate, DateTime refreshDate)
      {
        PoliticiansImagesDataRow row = NewRow(politicianKey, profileOriginalDate, headshotDate, headshotResizeDate, refreshDate);
        AddRow(row);
      }
      ...
      public DataColumn RefreshDateColumn { get { return this.Columns["RefreshDate"]; } }
      ...
      private void InitAllColumns()
      {
        ...
        _column.AllowDBNull = false;
        base.Columns.Add(_column);
        _column = new DataColumn("RefreshDate", typeof(DateTime));
        _column.AllowDBNull = false;
        base.Columns.Add(_column);
      }
    ...
    public static partial class PoliticiansImagesData
    {
      ...
      public enum Column { PoliticianKey, ProfileOriginalDate, HeadshotDate, HeadshotResizeDate, RefreshDate }
      ...
      private static Dictionary<Column, string> ColumnDictionary = new Dictionary<Column, string>() {
        ...
        { Column.RefreshDate, "RefreshDate" } };
      ...
      public static void Insert(String politicianKey, DateTime profileOriginalDate, DateTime headshotDate, DateTime headshotResizeDate, DateTime refreshDate, int commandTimeout = -1)
      {
        string cmdText = "INSERT INTO PoliticiansImagesData (PoliticianKey,ProfileOriginalDate,HeadshotDate,HeadshotResizeDate,RefreshDate) VALUES (@PoliticianKey,@ProfileOriginalDate,@HeadshotDate,@HeadshotResizeDate,@RefreshDate)";
        DbCommand cmd = VoteImagesLocalDb.GetCommand(cmdText, commandTimeout);
        VoteImagesLocalDb.AddCommandParameter(cmd, "PoliticianKey", politicianKey);
      ...
      public static string SelectAllCommandText
      {
        get
        {
          return "SELECT PoliticianKey,ProfileOriginalDate,HeadshotDate,HeadshotResizeDate,RefreshDate FROM PoliticiansImagesData";
        }
      }

      public static PoliticiansImagesDataTable GetAllData(int commandTimeout = -1)
      {
        string cmdText = "SELECT PoliticianKey,ProfileOriginalDate,HeadshotDate,HeadshotResizeDate,RefreshDate FROM PoliticiansImagesData";
        DbCommand cmd = VoteImagesLocalDb.GetCommand(cmdText, commandTimeout);
      ...
      public static string RefreshDateColumnName { get { return "RefreshDate"; } }
      ...
      public static DateTime? GetRefreshDateByPoliticianKey(String politicianKey)
      {
        return _GetRefreshDateByPoliticianKey(politicianKey, null);
      }

      public static DateTime? GetRefreshDate(String politicianKey)
      {
        return GetRefreshDateByPoliticianKey(politicianKey);
      }

      public static DateTime GetRefreshDateByPoliticianKey(String politicianKey, DateTime defaultValue)
      {
        return _GetRefreshDateByPoliticianKey(politicianKey, defaultValue).Value;
      }

      public static DateTime GetRefreshDate(String politicianKey, DateTime defaultValue)
      {
        return GetRefreshDateByPoliticianKey(politicianKey, defaultValue);
      }

      private static DateTime? _GetRefreshDateByPoliticianKey(String politicianKey, DateTime? defaultValue)
      {
        object result;
        string cmdText = "SELECT RefreshDate FROM PoliticiansImagesData WHERE PoliticianKey=@PoliticianKey";
        DbCommand cmd = VoteImagesLocalDb.GetCommand(cmdText, -1);
        VoteImagesLocalDb.AddCommandParameter(cmd, "PoliticianKey", politicianKey);
        result = VoteImagesLocalDb.ExecuteScalar(cmd);
        if (result == null || result == DBNull.Value) return defaultValue;
      ...
      {
        string cmdText = "SELECT PoliticianKey,ProfileOriginalDate,HeadshotDate,HeadshotResizeDate,RefreshDate FROM PoliticiansImagesData WHERE PoliticianKey=@PoliticianKey";
        DbCommand cmd = VoteImagesLocalDb.GetCommand(cmdText, commandTimeout);
        VoteImagesLocalDb.AddCommandParameter(cmd, "PoliticianKey", politicianKey);
        return FillTable(cmd, PoliticiansImagesDataTable.ColumnSet.All);
      }
      ...
      public static int UpdateRefreshDateByPoliticianKey(DateTime newValue, String politicianKey)
      {
        string cmdText = "UPDATE PoliticiansImagesData SET RefreshDate=@newValue WHERE PoliticianKey=@PoliticianKey";
        DbCommand cmd = VoteImagesLocalDb.GetCommand(cmdText, -1);
        VoteImagesLocalDb.AddCommandParameter(cmd, "PoliticianKey", politicianKey);
        VoteImagesLocalDb.AddCommandParameter(cmd, "newValue", newValue);
        return VoteImagesLocalDb.ExecuteNonQuery(cmd);
      ...
      public static int UpdateRefreshDate(DateTime newValue, String politicianKey)
      {
        return UpdateRefreshDateByPoliticianKey(newValue, politicianKey);
      }
