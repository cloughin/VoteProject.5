...
namespace Vote
{
  ...
  //   correctable by adding an additional parameter of Empty at the end of 
  //   the parameter list.
  ...
  public static class SocialMedia
  {
    ...
    static SocialMedia()
    {
      ...
      { // The four parameters:
        ...
        // 4. Enabled flag
        new SocialMedium("YouTube", null, "Channel or Video", "/images/YouTube.png", "/images/youtube.2.new.png", true),
        ...
        new SocialMedium("RSSFeed", "RSS Feed", Empty, "/images/RSS.png", "/images/rss.2.png", true),
        ...
        new SocialMedium("GoFundMe", null, "Page", "/images/gofundme.sm.png", "/images/gofundme.png", true),
        new SocialMedium("Crowdpac", null, "Page", "/images/crowdpac.sm.png", "/images/crowdpac.png", true),
        new SocialMedium("Podcast", null, "Page", "/images/podcast-icon.sm.png", "/images/podcast-icon-2.png", true)
      };
    ...
    //    if (IsNullOrWhiteSpace(webAddress)) continue;
    ...
    public static Control GetAnchors(DataRow row, bool addClearBoth = true,
      bool useLargeIcons = false)
    {
      return GetAnchors(row, out _, addClearBoth, useLargeIcons);
    }
