...
{
  [PageInitializers]
  public partial class UpdateIntro2Page : SecurePoliticianPage
  {
    ...
    {
      private readonly UpdateIntro2Page _Page;
      ...
      {
        return Politicians.GetColumnExtended(Column, _Page.PoliticianKey);
      }
      ...
      {
        _Page.LogPoliticiansDataChange(Column, oldValue, newValue);
      }

      protected override bool Update(object newValue)
      {
        Politicians.UpdateColumnExtended(Column, newValue, _Page.PoliticianKey);
        return true;
      }
    }
    ...
    protected override void OnPreRender(EventArgs e)
    {
      ...
      var viewIntroLink =
        PageCachingSubHeadingWithHelp.FindTemplateControl("ViewIntroLink") as
          HtmlAnchor;
      if (viewIntroLink != null) viewIntroLink.HRef = IntroPageUrl;

      var cacheExpirationMsg =
        PageCachingSubHeadingWithHelp.FindTemplateControl("CacheExpirationMsg") as
          HtmlGenericControl;
      if (cacheExpirationMsg != null) cacheExpirationMsg.InnerText = CachePages.DisplayExpiration(MemCache.CacheExpiration);
