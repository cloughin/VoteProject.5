...
AutoEventWireup="true" CodeBehind="UpdateIntro.aspx.cs" 
Inherits="Vote.Politician.UpdateIntroPage" %>
...
<asp:Content ID="HeadContent" EnableViewState="false" ContentPlaceHolderID="MasterHeadContent" runat="server">
  <style>
    .dob-dialog .ui-dialog-titlebar-close {
      display: none;
                                          }
    .dob-dialog p {
      text-align: left;
                  }
    .dob-dialog .date-picker-dob {
      margin-right: 10px;
                  }
  </style>
</asp:Content>
...
<%--        <p><em><span>&#x25ba;</span>View</em> your introductory page including your positions and views</p>--%>
  ...
  <div class="content-header maint-container shadow rounded-border clear-both">
    <user:SubHeadingWithHelp ID="PageCachingSubHeadingWithHelp" EnableViewState="false" runat="server"
      ...
      <ContentTemplate>
        ...
        <strong><a title="View Intro Page" id="ViewIntroLink" EnableViewState="false" target= "Show" runat="server">
  ...
  <div id="main-tabs" class="tab-control htab-control jqueryui-tabs start-hidden shadow">
      ...
      <ul class="tabs htabs unselectable">
          <li class="mt-social tab htab" EnableViewState="false" runat="server"><a href="#tab-social" onclick="this.blur()" id="TabMainSocial" EnableViewState="false" runat="server">Web Site & Social Media Links</a></li>
          <li class="mt-upload tab htab" EnableViewState="false" runat="server"><a href="#tab-upload" onclick="this.blur()" id="TabMainUpload" EnableViewState="false" runat="server">Upload Picture</a></li>
          <li class="mt-general tab htab" EnableViewState="false" runat="server"><a href="#tab-contact" onclick="this.blur()" id="TabMainContact" EnableViewState="false" runat="server">Contact & General Info</a></li>
          <li class="mt-bio2 tab htab" EnableViewState="false" runat="server"><a href="#tab-bio2" onclick="this.blur()" id="TabMainBio2" EnableViewState="false" runat="server">Biographical Info</a></li>
          <li class="mt-reasons tab htab" EnableViewState="false" runat="server"><a href="#tab-reasons" onclick="this.blur()" id="TabMainReasons" EnableViewState="false" runat="server">Reasons & Objectives</a></li>
      </ul>
          ...
          <ContentTemplate>
            ...
            <div class="inner-panel rounded-border">
              <div class="tab-panel-heading horz-center"><div class="center-inner">
                <div id="Div1" EnableViewState="false" runat="server" class="undo-button tiptip"
              ...
              <div class="instructions">
                <ul>
                  ...
                  <li><span>The http(s):// prefix is optional on all addresses</span></li>
                </ul>
              </div>

              <hr />
              <h5>Your Web Site and Email Address</h5>
              ...
              <div class="cols">
                ...
                <div class="col col1">
                  ...
                  <div class="medium website rounded-border shadow">
                    <h6>Web Site</h6>
                    <div class="icon-box"><a class="icon" target="Website" id="IconBoxPublicWebAddress" EnableViewState="false" runat="server"></a></div>
                ...
                <div class="col col2">
                  ...
                  <div class="medium email rounded-border shadow">
                    <h6>Email</h6>
                    <div class="icon-box"><a class="icon" id="IconBoxPublicEmail" EnableViewState="false" runat="server"></a></div>
                    <user:TextBoxWithNormalizedLineBreaks spellcheck="false" ID="ControlSocialPublicEmail" EnableViewState="false" runat="server"></user:TextBoxWithNormalizedLineBreaks>
                    <div class="tab-ast" id="AsteriskSocialPublicEmail" EnableViewState="false" runat="server"></div>
                    <div class="clear-both"></div>
                  </div>
              ...
              <div class="cols">
                ...
                <div class="col col1">
                  ...
                  <div class="medium youtube rounded-border shadow">
                    ...
                    <div class="icon-box"><a class="icon" target="Show" id="IconBoxYouTubeWebAddress" EnableViewState="false" runat="server"></a></div>
                  ...
                  <div class="col col2">
                    <div class="instructions youtube-instructions">
                      <ul>
                        <li><span>Enter the URL of your YouTube Channel</span></li>
<%--                        <li><span>Individual YouTube videos that address specific topics can be entered on the Biographical Info tab, the Reasons &amp; Objectives tab, or on your Issues page</span></li>--%>
                        <li><span>Individual YouTube videos that address specific topics can be entered on the Biographical Info tab or on the Reasons &amp; Objectives tab</span></li>
                        <li><span>If you do not have a YouTube channel, you can enter the URL of a specific YouTube video or a YouTube playlist instead of your channel URL</span></li>
                      </ul>
                    </div>
                  </div>
              ...
              <div class="cols">
                ...
                <div class="col col1">
                  ...
                  <div class="medium facebook rounded-border shadow">
                    ...
                    <div class="icon-box"><a class="icon" target="Show" id="IconBoxFacebookWebAddress" EnableViewState="false" runat="server"></a></div>
                  ...
                  <div class="medium flickr rounded-border shadow">
                    ...
                    <div class="icon-box"><a class="icon" target="Show" id="IconBoxFlickrWebAddress" EnableViewState="false" runat="server"></a></div>
                  ...
                  <div class="medium twitter rounded-border shadow">
                    ...
                    <div class="icon-box"><a class="icon" target="Show" id="IconBoxTwitterWebAddress" EnableViewState="false" runat="server"></a></div>
                  ...
                  <div class="medium rssfeed rounded-border shadow">
                    ...
                    <div class="icon-box"><a class="icon" target="Show" id="IconBoxRSSFeedWebAddress" EnableViewState="false" runat="server"></a></div>
                  ...
                  <div class="medium wikipedia rounded-border shadow">
                    ...
                    <div class="icon-box"><a class="icon" target="Show" id="IconBoxWikipediaWebAddress" EnableViewState="false" runat="server"></a></div>
                  ...
                  <div class="medium ballotpedia rounded-border shadow">
                    ...
                    <div class="icon-box"><a class="icon" target="Show" id="IconBoxBallotPediaWebAddress" EnableViewState="false" runat="server"></a></div>
                  ...
                  <div class="medium gofundme rounded-border shadow">
                    <h6 id="HeadingGoFundMeWebAddress" EnableViewState="false" runat="server"></h6>
                    <div class="icon-box"><a class="icon" target="Show" id="IconBoxGoFundMeWebAddress" EnableViewState="false" runat="server"></a></div>
                    <user:TextBoxWithNormalizedLineBreaks spellcheck="false" ID="ControlSocialGoFundMeWebAddress" EnableViewState="false" runat="server"></user:TextBoxWithNormalizedLineBreaks>
                    <div class="tab-ast" id="AsteriskSocialGoFundMeWebAddress" EnableViewState="false" runat="server"></div>
                    <div class="clear-both"></div>
                  </div>   
                ...
                <div class="col col2">
                  ...
                  <div class="medium vimeo rounded-border shadow">
                    ...
                    <div class="icon-box"><a class="icon" target="Show" id="IconBoxVimeoWebAddress" EnableViewState="false" runat="server"></a></div>
                  ...
                  <div class="medium googleplus rounded-border shadow">
                    ...
                    <div class="icon-box"><a class="icon" target="Show" id="IconBoxGooglePlusWebAddress" EnableViewState="false" runat="server"></a></div>
                  ...
                  <div class="medium linkedin rounded-border shadow">
                    ...
                    <div class="icon-box"><a class="icon" target="Show" id="IconBoxLinkedInWebAddress" EnableViewState="false" runat="server"></a></div>
                  ...
                  <div class="medium pinterest rounded-border shadow">
                    ...
                    <div class="icon-box"><a class="icon" target="Show" id="IconBoxPinterestWebAddress" EnableViewState="false" runat="server"></a></div>
                  ...
                  <div class="medium blogger rounded-border shadow">
                    ...
                    <div class="icon-box"><a class="icon" target="Show" id="IconBoxBloggerWebAddress" EnableViewState="false" runat="server"></a></div>
                  ...
                  <div class="medium webstagram rounded-border shadow">
                    ...
                    <div class="icon-box"><a class="icon" target="Show" id="IconBoxWebstagramWebAddress" EnableViewState="false" runat="server"></a></div>
                  ...
                  <div class="medium crowdpac rounded-border shadow">
                    <h6 id="HeadingCrowdpacWebAddress" EnableViewState="false" runat="server"></h6>
                    <div class="icon-box"><a class="icon" target="Show" id="IconBoxCrowdpacWebAddress" EnableViewState="false" runat="server"></a></div>
                    <user:TextBoxWithNormalizedLineBreaks spellcheck="false" ID="ControlSocialCrowdpacWebAddress" EnableViewState="false" runat="server"></user:TextBoxWithNormalizedLineBreaks>
                    <div class="tab-ast" id="AsteriskSocialCrowdpacWebAddress" EnableViewState="false" runat="server"></div>
                    <div class="clear-both"></div>
                  </div>   

                  <div class="medium podcast rounded-border shadow" id="PodcastEntry" runat="Server">
                    <h6 id="HeadingPodcastWebAddress" EnableViewState="false" runat="server"></h6>
                    <div class="icon-box"><a class="icon" target="Show" id="IconBoxPodcastWebAddress" EnableViewState="false" runat="server"></a></div>
                    <user:TextBoxWithNormalizedLineBreaks spellcheck="false" ID="ControlSocialPodcastWebAddress" EnableViewState="false" runat="server"></user:TextBoxWithNormalizedLineBreaks>
                    <div class="tab-ast" id="AsteriskSocialPodcastWebAddress" EnableViewState="false" runat="server"></div>
                    <div class="clear-both"></div>
                  </div>   
      ...
      <div id="tab-contact" class="content-panel tab-panel htab-panel">
        ...
        <asp:UpdatePanel ID="UpdatePanelContact" EnableViewState="true"
          UpdateMode="Conditional" runat="server">
          <ContentTemplate>
            ...
            <div class="inner-panel rounded-border">
              <div class="tab-panel-heading horz-center"><div class="center-inner">
                <div runat="server" EnableViewState="false" class="undo-button tiptip"
              ...
              <div class="input-element dateofbirth">
                <p class="fieldlabel">Date of Birth 
      ...
      <div id="tab-bio2" class="content-panel tab-panel htab-panel">
        ...
        <div id="bio2-tabs" class="bio2-tabs tab-control vtab-control jqueryui-tabs">
      ...
      <div id="tab-reasons" class="content-panel tab-panel htab-panel">
        ...
        <div id="reasons-tabs" class="reasons-tabs tab-control vtab-control jqueryui-tabs">
...
<div id="dob-dialog" class="hidden">
  <p>Please enter your date of birth to proceed. This will save us from having to look up and enter your age in this and subsequent elections. This is the only required data.</p>
  <p>&nbsp;</p>
  <user:TextBoxWithNormalizedLineBreaks spellcheck="false" EnableViewState="false" CssClass="shadow-2 date-picker-dob" runat="server"></user:TextBoxWithNormalizedLineBreaks>
  <input type="button" value="Save" class="button-1 button-smaller save-dob-button disabled" autofocus="autofocus"/>
</div>
