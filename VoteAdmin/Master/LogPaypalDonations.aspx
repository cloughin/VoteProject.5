...
AutoEventWireup="true" CodeBehind="LogPaypalDonations.aspx.cs"
Inherits="Vote.Master.LogPaypalDonations" %>
...
<asp:Content ID="MainContent" ContentPlaceHolderID="MasterMainContent" runat="server">
  <div id="outer">
    ...
    <div class="rounded-border boxed-group csv-upload-container">
      <div class="boxed-group-label">Select a PayPal .csv file to upload</div>
      <input name="CsvUpload" id="CsvUpload" type="file" />
    </div>
