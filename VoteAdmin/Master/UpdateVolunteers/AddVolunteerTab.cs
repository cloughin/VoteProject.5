...
namespace Vote.Master
{
  public partial class UpdateVolunteersPage
  {
    ...
    private class AddVolunteerTabItem : DataItemBase
    {
      ...
      private AddVolunteerTabItem(UpdateVolunteersPage page) : base(GroupName)
      {
        _Page = page;
      }
      ...
      private static AddVolunteerTabItem[] GetTabInfo(UpdateVolunteersPage page)
      {
        var addVolunteerTabInfo = new[]
        {
          ...
          new AddVolunteerTabItem(page) {Column = "Phone", Description = "Phone"},
          new AddVolunteerTabItem(page) {Column = "Password", Description = "Password"},
          new AddVolunteerTabItem(page)
          {
            Column = "State",
            Description = "State",
          ...
          new AddVolunteerTabItem(page) {Column = "Notes", Description = "Notes"}
        };
        ...
        // ReSharper restore UnusedMember.Local
      {
        ...
        if (!page.IsPostBack)
        {
          StateCache.Populate(page.ControlAddVolunteerState, "--- Select state ---",
            Empty);
    ...
    protected void ButtonAddVolunteer_OnClick(object sender, EventArgs e)
    {
      try
      {
        ...
        if (IsNullOrWhiteSpace(password)) password = MakeUniquePassword();
