...
namespace Vote.Master
{
  public partial class SecurityPage : SecurePage, ISuperUser
  {
    ...
    public static string Single_Key_Str(string tableName, string column, string keyName,
      string keyValue)
    {
      var sql = "SELECT " + column.Trim() + " FROM " + tableName.Trim() + " WHERE " + keyName.Trim() +
        " = " + SqlLit(keyValue.Trim());
    ...
    protected void Button_Update_UserName_Pasword_Click(object sender, EventArgs e)
    {
      try
      {
        ...
        if (
          !string.Equals(TextBox_User_Name.Text.Trim(), Label_UserName.Text,
            StringComparison.OrdinalIgnoreCase) && Is_Valid_Security(TextBox_User_Name.Text.Trim()))
      ...
      try
      {
        ...
        switch (RadioButtonList_User_Type.SelectedValue)
        {
          case "MASTER":
            ...
            Msg.Text =
              Ok("The Master User has been created with maximum capabilities." +
          ...
          case "ADMIN":
            ...
            Msg.Text =
              Message("The State Adminsitrator User has been created." +
          ...
          case "COUNTY":
            ...
            Msg.Text =
              Message("The County Adminsitrator User has been created." +
          ...
          case "LOCAL":
            ...
            Msg.Text =
              Message("The Local District Adminsitrator User has been created." +
    ...
    protected void Button_Different_User_Click(object sender, EventArgs e)
    {
      try
      {
        ...
        Msg.Text =
          Message("Select a user from the Users List Box to edit an existing user." +
    ...
    protected void ListBox_Organization_SelectedIndexChanged(object sender, EventArgs e)
    {
      try
      {
        ...
        Msg.Text =
          Ok(
            "The user has been updated to permit administration for the Oranization whose code is: " +
