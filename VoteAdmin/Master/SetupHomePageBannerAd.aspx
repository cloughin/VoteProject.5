...
AutoEventWireup="true" CodeBehind="SetupHomePageBannerAd.aspx.cs" 
Inherits="Vote.Master.SetupHomePageBannerAdPage" %>
        ...
        <div id="ContainerSetupAd" runat="server">
          ...
          <div class="input-element adenabled">
            <div class="databox kalypto-checkbox">
              ...
              <div class="kalypto-checkbox-label">Enable Ad on home page</div>
          ...
          <div class="delete-button">
            <asp:Button ID="ButtonDeleteAd" EnableViewState="false" 
                        ...
                        Title="Delete this home page ad" 
          ...
          <div id="SampleAd" class="sample-ad" runat="server">
            ...
            <hr/>
            <a href="/" class="home-page-link" target="ext" id="HomePageLink" runat="server">View on Home page</a>
          </div>
          ...
          <div class="update-button">
            <asp:Button ID="ButtonSetupAd" EnableViewState="false" 
                        ...
                        Title="Update the home page ad setup"
