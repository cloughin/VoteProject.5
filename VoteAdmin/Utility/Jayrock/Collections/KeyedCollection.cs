...
namespace Jayrock.Collections
{
  ...
  {
    private readonly Hashtable _ValueByKey;
      // TODO: Mark [ NonSerializable ] and implement IDeserializationCallback
    ...
    private Hashtable ValueByKey { get { return _ValueByKey; } }
