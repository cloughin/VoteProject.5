...
namespace Jayrock
{
  ...
  public static class UnixTime
  {
    private static readonly int[] Days =
      {
        -1, 30, 58, 89, 119, 150, 180, 211, 242,
        272, 303, 333, 364
      };

    private static readonly int[] LeapDays =
      {
        -1, 30, 59, 90, 120, 151, 181, 212, 243
        , 273, 304, 334, 365
      };
    ...
    public static DateTime ToDateTime(long time)
    {
      ...
      var tmp = (int) (time/secondsPerYear) + 70;
      ...
      var yearDay = (int) (time/secondsPerDay);
      ...
      var yearDaysByMonth = isLeapYear ? LeapDays : Days;
      var month = 1;
      while (yearDaysByMonth[month] < yearDay) month++;

      var mday = yearDay - yearDaysByMonth[month - 1];
    ...
    {
      return (((y - 1)/4) - ((y - 1)/100) + ((y + 299)/400) -
        /* Leap years 1900 - 1970 = */ 17);
    }
  }
}