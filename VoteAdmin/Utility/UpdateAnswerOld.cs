...
//    public UpdateAnswerOld(Usage usage)
//    {
//      _Usage = usage;
//    }
...
//      // Commented because I can't see where it's used, but I could be wrong
...
//      string moreClasses, MonitorInstance monitor)
//    {
//      var wasUploadedByCandidate = row.YouTubeSource ==
//        YouTubeInfo.VideoUploadedByCandidateMessage;
...
//          null, wasUploadedByCandidate, "Video was uploaded by candidate", "fromcandidate clearfix",
//          null, null, null, "kalypto-deferred");
//      }
...
//          true, "Source Description", "source", null, null, null);
