...
namespace DB.Vote
{
  public partial class PoliticiansRow
  {
    ...
    public string PublicAddress
    {
      ...
      {
        var result = Address;
        if (string.IsNullOrWhiteSpace(result)) result = StateAddress;
        return result;
      }
    }
    ...
    public string PublicCityStateZip
    {
      get
      {
        ...
        if (string.IsNullOrWhiteSpace(result)) result = StateCityStateZip;
        return result;
      }
    }
    ...
    public string PublicEmail
    {
      ...
      {
        var result = Email;
        if (string.IsNullOrWhiteSpace(result)) result = StateEmail;
        return result;
      }
    }
    ...
    public string PublicPhone
    {
      ...
      {
        var result = Phone;
        if (string.IsNullOrWhiteSpace(result)) result = StatePhone;
        return result;
      }
    }
    ...
    public string PublicWebAddress
    {
      get
      {
        ...
        if (string.IsNullOrWhiteSpace(result)) result = StateWebAddress;
        return result;
      }
    }
  ...
  public partial class Politicians
  {
    ...
    {
      Insert(politicianKey, password, string.Empty, officeKey, string.Empty, string.Empty,
        string.Empty,
        GetStateCodeFromKey(politicianKey), firstName, middleName, nickname, lastName,
        lastName.StripAccents(), lastName.StripVowels(), suffix, string.Empty, string.Empty,
        string.Empty, string.Empty, string.Empty, string.Empty, string.Empty, string.Empty,
        string.Empty, string.Empty, partyKey, string.Empty, string.Empty, string.Empty,
        string.Empty, string.Empty, string.Empty, string.Empty, string.Empty, string.Empty,
        string.Empty,
        ...
        //false, 
        false, DateTime.UtcNow, 0,
        VotePage.DefaultDbDate,
        //isLDSIncumbent: false,
        0, VotePage.DefaultDbDate, string.Empty, string.Empty, string.Empty, string.Empty,
        string.Empty,
        string.Empty, string.Empty, string.Empty, string.Empty, string.Empty, string.Empty,
        string.Empty,
        string.Empty, string.Empty, default(TimeSpan), VotePage.DefaultDbDate, string.Empty, false,
        false);
    }
    ...
    {
      const string cmdText =
        "SELECT COUNT(*) FROM Politicians WHERE LiveOfficeKey=@OfficeKey OR TemporaryOfficeKey=@OfficeKey";
      var cmd = VoteDb.GetCommand(cmdText, -1);
