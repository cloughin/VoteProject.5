...
{
  internal sealed class IssueReportIssueListResponsive : ResponsiveReport
  {
    #region Private
      ...
      IEnumerable<IGrouping<string, DataRow>> issueGroups, string heading)
    {
      ...
      var sectionContent = new HtmlDiv().AddTo(ReportContainer, "accordion-content section-content");
