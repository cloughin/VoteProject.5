...
function ($, master, util, monitor) {
  ...
  function initPage() {
    ...
    $("#tab-adduser .select-user-security").change(function () {
      ...
      $("#tab-adduser .input-element.user-local-key").toggleClass("hidden", level !== "LOCAL");
    });
  ...
  function addUserDataChanged() {
    ...
    var localKey = $("#tab-adduser .select-user-local-key").val();
    ...
    util.ajax({
      ...
      success: function (result) {
        ...
        $scroller.html('<table>' +
            ...
            '<th>County Code</th><th>Local Key</th><th></th><th></th></tr></thead>' +
  ...
  function populateAddUsersLocalDropdown() {
    var $dropdown = $("#tab-adduser .select-user-local-key");
    var stateCode = $("#tab-adduser .select-user-state-code").val();
    var countyCode = $("#tab-adduser .select-user-county-code").val();
