var scrolltotop={setting:{startline:400,scrollto:0,scrollduration:1000,fadeduration:[500,500]},controlHTML:'<img src="/images/topcontrol.png" />',controlattrs:{offsetx:5,offsety:5},anchorkeyword:'#top',state:{isvisible:false,shouldvisible:false},scrollup:function(){if(!this.cssfixedsupport)this.$control.css({opacity:0})
