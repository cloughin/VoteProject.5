...
namespace Vote.Admin
{
  public partial class UpdateElectionsPage
  {
    ...
    private class ChangeInfoTabItem : ElectionsDataItem
    {
      ...
      protected override string GetCurrentValue() => Column == "ChangeLocals"
        ? false.ToString()
        ...
        // ReSharper restore UnusedMember.Local
      {
        ...
        if (!page.ShowChangeInfo) page.TabChangeInfoItem.Visible = false;

        switch (page.AdminPageLevel)
        {
          case AdminPageLevel.State:
          case AdminPageLevel.Federal: break; // no action
      ...
      {
        if (Column != "ChangeLocals") base.Log(oldValue, newValue);
      }
      ...
      protected override bool Update(object newValue)
      {
        ...
        if ((Page.AdminPageLevel == AdminPageLevel.State ||
          Page.AdminPageLevel == AdminPageLevel.Federal) && Column == "IsViewable")
        {
    ...
    protected void ButtonChangeInfo_OnClick(object sender, EventArgs e)
    {
      ...
      switch (ChangeInfoReloading.Value)
      {
        case "reloading":
        {
          ChangeInfoReloading.Value = Empty;
        ...
        default:
          throw new VoteException(
            $"Unknown reloading option: '{ChangeInfoReloading.Value}'");
      }
    }
