...
AutoEventWireup="true" CodeBehind="SetUpComparePageBannerAd.aspx.cs" 
Inherits="VoteAdmin.Admin.SetUpComparePageBannerAdPage" %>
    ...
    <asp:UpdatePanel ID="UpdatePanelSetupAd" UpdateMode="Conditional" runat="server">
      <ContentTemplate>
        <div id="ContainerSetupAd" runat="server">
          <h6>Election: <em id="Election" EnableViewState="false" runat="server"></em></h6>
          <h6>Office: <em id="Office" EnableViewState="false" runat="server"></em></h6>
          ...
          <div class="input-element adenabled">
            <div class="databox kalypto-checkbox">
              ...
              <div class="kalypto-checkbox-label">Enable Ad on compare page</div>
          ...
          <div class="delete-button">
            <asp:Button ID="ButtonDeleteAd" EnableViewState="false" 
                        ...
                        Title="Delete this compare page ad" 
          ...
          <div id="SampleAd" class="sample-ad" runat="server">
            ...
            <hr/>
            <a href="/" class="compare-page-link" target="ext" id="ComparePageLink" runat="server">View on compare page</a>
          </div>
          ...
          <div class="update-button">
            <asp:Button ID="ButtonSetupAd" EnableViewState="false" 
                        ...
                        Title="Update the compare page ad setup"
