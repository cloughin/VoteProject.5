...
<ul class="main-tabs tabs htabs unselectable">
  <li class="edit-template tab htab" EnableViewState="false" runat="server">
    <a href="#tab-edittemplate" onclick="this.blur()" id="TabEditTemplate" EnableViewState="false" runat="server">Edit<br/>Template</a>
    <div class="tab-ast tiptip" title="There are unsaved changes to this template"></div>
  </li>
  <li class="tab htab" EnableViewState="false" runat="server">
    <a href="#tab-availablesubstitutions" onclick="this.blur()" id="TabAvailableSubstitutions" EnableViewState="false" runat="server">Available<br/>Substitutions</a>
  </li>
  <li class="tab htab" EnableViewState="false" runat="server">
    <a href="#tab-selectrecipients" onclick="this.blur()" id="TabSelectRecipients" EnableViewState="false" runat="server">Select<br/>Recipients</a>
  </li>
  <li class="tab htab" EnableViewState="false" runat="server">
    <a href="#tab-selectrecipientsinstructions" onclick="this.blur()" id="TabRecipientSelectionInstructions" EnableViewState="false" runat="server">Select Recipients<br/>Instructions</a>
  </li>
  <li class="tab htab" EnableViewState="false" runat="server">
    <a href="#tab-viewrecipients" onclick="this.blur()" id="TabViewRecipients" EnableViewState="false" runat="server">View<br/>Recipients</a>
  </li>
  <li class="tab htab" EnableViewState="false" runat="server">
    <a href="#tab-previewsample" onclick="this.blur()" id="TabPreviewSample" EnableViewState="false" runat="server">Preview<br/>Sample</a>
  </li>
  <li class="tab htab" EnableViewState="false" runat="server">
    <a href="#tab-emailoptions" onclick="this.blur()" id="TabEmailOptions" EnableViewState="false" runat="server">Email<br/>Options</a>
  </li>
  <li class="tab htab" EnableViewState="false" runat="server">
    <a href="#tab-sendemails" onclick="this.blur()" id="TabSendEmails" EnableViewState="false" runat="server">Send<br/>Emails</a>
  </li>
  <li class="tab htab" EnableViewState="false" runat="server">
    <a href="#tab-emaillogging" onclick="this.blur()" id="TabEmailLogging" EnableViewState="false" runat="server">Email<br/>Logging</a>
  </li>
  <li class="tab htab" EnableViewState="false" runat="server" id="TabEmailTypes">
    <a href="#tab-emailtypes" onclick="this.blur()" id="A1" EnableViewState="false" runat="server">Email<br/>Types</a>
  </li>
  <li class="tab htab" EnableViewState="false" runat="server" id="TabMasterItem">
    <a href="#tab-masteronly" onclick="this.blur()" id="TabMaster" EnableViewState="false" runat="server">Master<br/>Functions</a>
  </li>
</ul>
...
<div id="tab-edittemplate" class="main-tab content-panel tab-panel htab-panel">
  <div class="inner-panel rounded-border">
    ...
    <div class="code-edit-heading subject-edit-heading">
      <p class="mainlabel">Subject</p>
      <div class="undo-redo">
        <div class="undo tiptip" title="Undo"></div>
        <div class="redo tiptip" title="Redo"></div>
      </div>
    </div>
    <div id="subject-editor" class="code-edit subject shadow"></div>
    <div class="code-edit-heading body-edit-heading">
      <p class="mainlabel">Body</p>
      <div class="undo-redo">
        <div class="undo tiptip" title="Undo"></div>
        <div class="redo tiptip" title="Redo"></div>
      </div>
    ...
    <div id="body-editor-tabs" class="jqueryui-tabs shadow">
      ...
      <ul class="htabs unselectable">
        <li class="tab htab" EnableViewState="false" runat="server">
          <a href="#tab-body-html" onclick="this.blur()" id="TabBodyHtml" EnableViewState="false" runat="server">Body Html</a>
        </li>
        <li class="tab htab" EnableViewState="false" runat="server">
          <a href="#tab-body-rendered" onclick="this.blur()" id="TabBodyRendered" EnableViewState="false" runat="server">Rendered Without Substitutions</a>
        </li>
      </ul>
      ...
      <div id="tab-body-rendered">
        <div class="inner rounded-border">
          <iframe></iframe>
        </div>
      </div>
    ...
    <input type="button" value="Insert Embedded Key Value" class="button-1 button-smallest insert-embedded-button"/>
    <div class="email-type">
      <p class="mainlabel">
        Email Type:
        <select runat="server" class="edit-template-email-type" id="EditTemplateEmailType">
  ...
  <div class="inner-panel rounded-border">
    <div class="inner">
      <div class="instructions">
        <ul>
          <li>
            <span>Double click a <em>substitution name</em> to add it to your template at the cursor position.</span>
          </li>
        </ul>
      </div>
      ...
      <div class="conditionals col1">
        <p class="conditionals">
          <span class="escape">{{</span><span class="keyword">if</span>
          <select class="if-condition">
            <option value="= ">= &lt;comparand&gt;</option><option value="!= ">!= &lt;comparand&gt;</option><option value="&gt; ">&gt; &lt;comparand&gt;</option><option value="&gt;= ">&gt;= &lt;comparand&gt;</option><option value="&lt; ">&lt; &lt;comparand&gt;</option><option value="&lt;= ">&lt;= &lt;comparand&gt;</option><option value="match ">match &lt;comparand&gt;</option><option value="notmatch ">notmatch &lt;comparand&gt;</option><option value="empty">empty</option><option value="notempty">notempty</option>
          </select><span class="escape">}}</span> &lt;test value&gt; <span class="escape">{{</span><span class="keyword">then</span><span class="escape">}}</span> &lt;true value&gt;
        </p>
        <p class="conditionals">
          <span class="escape">{{</span><span class="keyword">elseif</span>
          <select class="elseif-condition">
            <option value="= ">= &lt;comparand&gt;</option><option value="!= ">!= &lt;comparand&gt;</option><option value="&gt; ">&gt; &lt;comparand&gt;</option><option value="&gt;= ">&gt;= &lt;comparand&gt;</option><option value="&lt; ">&lt; &lt;comparand&gt;</option><option value="&lt;= ">&lt;= &lt;comparand&gt;</option><option value="match ">match &lt;comparand&gt;</option><option value="notmatch ">notmatch &lt;comparand&gt;</option><option value="empty">empty</option><option value="notempty">notempty</option>
          </select><span class="escape">}}</span> &lt;test value&gt; <span class="escape">{{</span><span class="keyword">then</span><span class="escape">}}</span>...
        </p>
        <p class="conditionals"><span class="escape">{{</span><span class="keyword">else</span><span class="escape">}}</span> &lt;false value&gt;</p>
        <p class="conditionals">
          <span class="escape">{{</span><span class="keyword">endif</span><span class="escape">}}</span>
        </p>
      </div>
      ...
      <div class="conditionals col3">
        <div class="elseif">
          <input readonly="readonly" class="spinner elseif-spinner" value="0"/><span class="label"><span class="keyword">elseif</span>s to include</span>
        </div>
        <div class="else input-element">
          <div>
            <input type="checkbox" class="else-checkbox kalypto"/>
          </div>
          <div class="label">include <span class="keyword">else</span></div>
        </div>
      </div>
      <div class="clear-both"></div>
      ...
      <div class="fail-directive">
        ...
        <p class="conditionals">
          Use this in a conditional after <span class="escape">{{</span><span class="keyword">then</span><span class="escape">}}</span>
          ...
          missing (for example, an election).
        </p>
      </div>
    </div>
  </div>
...
<div class="col col1 rounded-border boxed-group">
  ...
  <div class="recipient-buttons rounded-border control-box">
    ...
    <div class="organizations">
      <asp:RadioButton ID="RecipientsOrganizations" runat="server"
  ...
  <div class="org-contacts-buttons rounded-border control-box">
    <p class="mainlabel">Contacts to Use</p>
    <div>
      <asp:RadioButton ID="RecipientsPrimaryContacts" runat="server"
                       Text="Primary contact only" Value="Primary"
                       CssClass="use-primary-contacts is-option-click"
                       Checked="True"
                       GroupName="RecipientsOrgContacts"/>
    </div>
    <div>
      <asp:RadioButton ID="RecipientsAllContacts" runat="server"
                       Text="All contacts" Value="All"
                       CssClass="use-all-contacts is-option-click"
                       GroupName="RecipientsOrgContacts"/>
    </div>
  </div>
...
<div class="col rounded-border boxed-group district-options">
  ...
  <div class="district-filtering col control-box rounded-border">
    ...
    <p id="DistrictsAll" class="sublabel">
      <input
...
<div class="col rounded-border boxed-group org-options">
  <div class="boxed-group-label">Organization Options</div>
  <div class="org-filtering rounded-border control-box">
    <p class="mainlabel">Organization Type</p>
    <div>
      <select id="OrganizationTypes" class="select-org-type is-option-click" runat="server"></select>
    </div>
    <p class="mainlabel">Organization SubType</p>
    <div>
      <select class="select-org-subtype is-option-click"><option>All subtypes</option></select>
    </div>
    <p class="mainlabel">Ideology</p>
    <div>
      <select id="OrganizationIdeologies" class="select-ideology is-option-click" runat="server"></select>
    </div>
  </div>
  <div class="org-tags rounded-border control-box">
    <p class="mainlabel">Email Tags</p>
    <p class="email-tags"></p>
  </div>
</div>
...
<div class="col rounded-border boxed-group elections-options">
  ...
  <div class="col control-box rounded-border election-filter-type hidden">
    ...
    <div class="general-election-filtering">
      ...
      <label for="RecipientsGeneralElectionFiltering">General (G)</label>
    </div>
    <div class="offyear-election-filtering">
      ...
      <label for="RecipientsOffYearElectionFiltering">Off-year (O)</label>
    </div>
    <div class="special-election-filtering">
      ...
      <label for="RecipientsSpecialElectionFiltering">Special election (S)</label>
    </div>
    <div class="state-primary-election-filtering">
      ...
      <label for="RecipientsStatePrimaryElectionFiltering">State primary (P)</label>
    </div>
    <div class="general-runoff-election-filtering">
      <input type="checkbox" id="RecipientsGeneralRunoffElectionFiltering"
             class="is-option-click" value="R"/>
      <label for="RecipientsGeneralRunoffElectionFiltering">General runoff (R)</label>
    </div>
    <div class="primary-runoff-election-filtering">
      <input type="checkbox" id="RecipientsPrimaryRunoffElectionFiltering"
             class="is-option-click" value="Q"/>
      <label for="RecipientsPrimaryRunoffElectionFiltering">Primary runoff (Q)</label>
    </div>
    <div class="presidential-primary-election-filtering">
      ...
      <label for="RecipientsPresidentialPrimaryElectionFiltering">Presidential primary (B)</label>
    </div>
  </div>
  ...
  <div class="ad-filtering col control-box rounded-border">
    <p class="mainlabel">Ad Filtering</p>
    <div class="no-ad-filtering">
      <asp:RadioButton ID="RecipientsNoAdFiltering" runat="server"
                       Text="No ad filtering" Value="NoFiltering"
                       CssClass="is-option-click" Checked="True"
                       GroupName="RecipientsAdFiltering"/>
    </div>
    <div class="has-enabled-ad-filtering">
      <asp:RadioButton ID="RecipientsHasEnabledAdFiltering" runat="server"
                       Text="Has enabled ad" Value="HasEnabled"
                       CssClass="is-option-click"
                       GroupName="RecipientsAdFiltering"/>
    </div>
    <div class="has-disabled-ad-filtering">
      <asp:RadioButton ID="RecipientsDisabledAdFiltering" runat="server"
                       Text="Has disabled ad"
                       Value="HasDisabled" CssClass="is-option-click"
                       GroupName="RecipientsAdFiltering"/>
    </div>
    <div class="has-no-ad-filtering">
      <asp:RadioButton ID="RecipientsHasNoAdFiltering" runat="server"
                       Text="Has no ad" Value="HasNone"
                       CssClass="is-option-click"
                       GroupName="RecipientsAdFiltering"/>
    </div>
  </div>
...
<div class="col rounded-border boxed-group visitor-type-options visitor-options">
  ...
  <div class="control-box rounded-border visitor-types">
    <div class="">
      ...
      <label for="RecipientsVisitorsSampleBallots">Requested Ballot Choices</label>
    </div>
    <div class="">
  ...
  <div class="control-box rounded-border visitor-options-filter">
    <div class="col col1">
      ...
      <div class="visitors-with-known-districts exclusive-pair">
        ...
        <label for="RecipientsVisitorsWithDistrictCoding">Only With Geo Coding</label>
      </div>
      <div class="visitors-with-unknown-districts">
        ...
        <label for="RecipientsVisitorsWithoutDistrictCoding">Only Without Geo Coding</label>
      </div>
    </div>
    ...
    <div class="col col3">
      <div class="date-range">
        ...
        <div>
          <input class="start-date is-option-change" type="text"/>
        </div>
        <p class="sublabel">End Date</p>
        <div>
          <input class="end-date is-option-change" type="text"/>
        </div>
      </div>
    </div>
...
<div class="col rounded-border boxed-group visitor-donor-options donor-options">
  ...
  <div class="col control-box rounded-border donor-options-filter">
  ...
  <div class="district-coding col control-box rounded-border">
    <div class="any-district-coding">
      <asp:RadioButton ID="DonorAnyDistrictCoding" runat="server"
                       Text="With or Without District Coding" Value="AnyCoding"
                       Checked="True"
                       GroupName="DonorDistrictCoding"/>
    </div>
    <div class="with-district-coding">
      <asp:RadioButton ID="DonorWithDistrictCoding" runat="server"
                       Text="Only With District Coding (for Ballot Choices)" Value="WithCoding"
                       GroupName="DonorDistrictCoding"/>
    </div>
    <div class="without-district-coding">
      <asp:RadioButton ID="DonorWithoutDistrictCoding" runat="server"
                       Text="Only Without District Coding" Value="WithoutCoding"
                       GroupName="DonorDistrictCoding"/>
    </div>
  </div>
...
<div class="filter-by-email-type">
  <input type="button" value="Filter By Email Type"
         class="filter-by-email-type-button button-2 button-smallest"/>
  <span class="filtering-msg invisible">on</span>
</div>

<div class="filter-by-login-date">
  <input type="button" value="Filter By Login Date"
         class="filter-by-login-date-button button-2 button-smallest"/>
  <span class="filtering-msg invisible">on</span>
</div>
...
<div id="tab-selectrecipientsinstructions" class="main-tab content-panel tab-panel htab-panel instructions-page">
  <div class="inner-panel rounded-border">
    <div class="inner">
      ...
      <p class="intro">
        Use the <em>Select Recipients</em> tab to create a list of recipients (a batch) for
      ...
      <p class="intro">
        Each batch consists of a single <i>contact type</i> (see below). The contact type
      ...
      <div class="instructions">
        <ul>
          <li>
            <p>
              <span>First, select a <em>Contact Type</em></span>
            </p>
            <p>
              <span>
                There are five main types of contacts: <i>Election Admins</i>, <i>Candidates</i>,
                ...
                selection controls which other selections are available for the batch.
              </span>
            </p>
          </li>
          <li>
            <p>
              <span>Next, select <em>Jurisdictions</em></span>
            </p>
            <p>
              <span>
                The jurisdictions selections let you filter the recipients by geographic
                ...
                check or uncheck all entries.
              </span>
            </p>
            <p>
              <span>
                A <em>Counties</em> checkbox list is available for County and Local Admins,
                County and Local Candidates, and Website Visitors. A <em>Local Districts</em> checkbox
                is available for Local Admins and Candidates.
              </span>
            </p>
          </li>
          <li>
            <p>
              <span>
                <em>Contacts to Use</em>
              </span>
            </p>
            <p>
              <span>
                For Election Admins, we maintain both a main and an alternate contact
                (although they may not both have data). You can select whether to include only
                the main contact, or to use both contacts, if available.
              </span>
            </p>
          </li>
          <li>
            <p>
              <span>
                <em>Election Filtering</em>
              </span>
            </p>
            <p>
              <span>Election Filtering allows the recipients to be restricted based on elections.</span>
            </p>
            <p>
              <span>
                <i>Has election of selected type(s)</i> is available for Election Admins and Candidates.
            ...
            <ul>
              <li>
                <p>
                  <span>Choose one or more of the five <i>Election Filter Types</i>.</span>
                </p>
              </li>
              <li>
                <p>
                  <span>
                    Choose <i>Closest future election</i> or <i>Most recent past election</i> to
              ...
              <li>
                <p>
                  <span>The selection can be limited to only publicly viewable elections.</span>
                </p>
              </li>
            </ul>
            <p>
              <span>
                <i>Does not have election of selected type(s)</i> is available for Admins only and
                operates similarly.
              </span>
            </p>
            <p>
              <span>
                Single election selection is available for Candidates and Party Officials,
          ...
          <li>
            ...
            <p>
              <span>
                For Candidates, we keep up to five different email addresses. The
                ...
                email address are filtered out by recipient selection).
              </span>
            </p>
          </li>
          <li>
            ...
            <p>
              <span>
                For Party Officials you can filter by specific parties (if a single
                state is selected).
              </span>
            </p>
          </li>
          <li>
            <p>
              <span>
                <em>Website Visitor Options</em>
              </span>
            </p>
            <p>
              <span>
                Website Visitors have a special set of selections available. There are
                ...
                restrict recipients to a range of dates in which they registered.
              </span>
            </p>
          </li>
        </ul>
  ...
  <div class="inner-panel rounded-border">
    ...
    <div class="cols col2">
      ...
      <div id="preview-sample-tabs" class="jqueryui-tabs shadow">
        ...
        <ul class="htabs unselectable">
          <li class="tab htab" EnableViewState="false" runat="server">
            <a href="#tab-preview-html" onclick="this.blur()" id="TabPreviewHtml" EnableViewState="false" runat="server">Body Html</a>
          </li>
          <li class="tab htab" EnableViewState="false" runat="server">
            <a href="#tab-preview-rendered" onclick="this.blur()" id="TabPreviewRendered" EnableViewState="false" runat="server">Rendered</a>
          </li>
        </ul>
...
<ul class="htabs unselectable">
  <li class="tab htab" EnableViewState="false" runat="server">
    <a href="#tab-emaillogging-basicfiltering" onclick="this.blur()" id="TabEmailLoggingBasicFiltering" EnableViewState="false" runat="server">Basic<br/>Filtering</a>
  </li>
  <li class="tab htab" EnableViewState="false" runat="server">
    <a href="#tab-emaillogging-morefiltering" onclick="this.blur()" id="TabEmailLoggingMoreFiltering" EnableViewState="false" runat="server">Election, Office and<br/>Candidate Filtering</a>
  </li>
  <li class="tab htab" EnableViewState="false" runat="server">
    <a href="#tab-emaillogging-politicianfiltering" onclick="this.blur()" id="TabEmailLoggingPoliticianFiltering" EnableViewState="false" runat="server">Politician<br/>Filtering</a>
  </li>
  <li class="tab htab" EnableViewState="false" runat="server">
    <a href="#tab-emaillogging-batchfiltering" onclick="this.blur()" id="TabEmailLoggingBatchFiltering" EnableViewState="false" runat="server">Batch<br/>Filtering</a>
  </li>
  <li class="tab htab" EnableViewState="false" runat="server">
    <a href="#tab-emaillogging-logfilteringinstructions" onclick="this.blur()" id="TabLogFilteringInstructions" EnableViewState="false" runat="server">Log Filtering<br/>Instructions</a>
  </li>
  <li class="tab htab" EnableViewState="false" runat="server">
    <a href="#tab-emaillogging-getlogentries" onclick="this.blur()" id="TabEmailLoggingGetLogEntries" EnableViewState="false" runat="server">Get Log<br/>Entries</a>
  </li>
</ul>
  ...
  <div class="col col1">
    ...
    <div class="rounded-border boxed-group contact-types-box">
      ...
      <div class="contact-types rounded-border control-box">
        ...
        <div>
          <input type="checkbox" id="ContactTypeO" checked="checked" value="O"/>
          <label for="ContactTypeO">Organizations</label>
        </div>
      </div>
    </div>
  ...
  <div class="col col2">
    ...
    <div class="rounded-border boxed-group addresses-box">
      ...
      <div class="addresses-boxes rounded-border control-box">
        ...
        <div>
          <input class="from-addresses" type="text"/>
        </div>
        <p class="mainlabel">To Address</p>
        <div>
          <input class="to-addresses" type="text"/>
        </div>
        <p class="mainlabel">Vote USA User Name</p>
        <div>
          <input class="user-names" type="text"/>
        </div>
      </div>
    </div>
...
<div id="tab-emaillogging-morefiltering">
  ...
  <div class="col instructions">
    <ul>
      <li>
        <span>You can filter log entries by either:</span>
        <ul>
          <li>
            <span>One or more elections within a single state, county, or local district.</span>
          </li>
          <li>
            <span>One or more offices within a single election.</span>
          </li>
          <li>
            <span>One or more candidates within a single office.</span>
          </li>
        </ul>
      </li>
    </ul>
...
<div id="tab-emaillogging-politicianfiltering">
  <div class="col rounded-border boxed-group search">
    ...
    <div class="instructions">
      <ul>
        <li>
          <span><em>Double click</em> or click the blue arrow to add a politician to the list on the right.</span>
        </li>
        <li>
          <span>Only politicians in states that are selected on the <em>Basic Filtering</em> tab are included in this list.</span>
        </li>
      </ul>
    </div>
  ...
  <div class="col rounded-border boxed-group selections">
    ...
    <div class="instructions">
      <ul>
        <li>
          <span>Email targeted to these politicians will be shown on the <em>Log Results</em> tab.</span>
        </li>
      </ul>
    </div>
  ...
  <div class="upper">
    <div class="col search-string-instructions instructions">
      <ul>
        <li>
          <span>
            <em>Date</em>, <em>Success</em>,
            <em>FromAddress</em> and <em>User Name</em> filtering from
            the <em>Basic Filtering</em> tab applies to this tab.
          </span>
        </li>
        <li>
          <span>
            Enter optional search strings, one per line, to limit the
            batch results shown.
          </span>
        </li>
        <li>
          <span>
            Use the <i>Join strings by</i> selection to control whether <i>all</i> or <i>any</i> of the search string must
            appear in the in the <em>Description</em> to be shown.
          </span>
        </li>
        <li>
          <span>
            Check batches you want to view then click <i>Open Batches</i> to display
            the emails in the <em>Get Log Entries</em> tsb.
          </span>
        </li>
        <li>
          <span>Right click for <em>context menu</em>.</span>
        </li>
      </ul>
    </div>
    <div class="col search-string-col">
      <select class="add-template-name">
        <option value="first">&lt;Add template name to search strings&gt;</option>
      </select>
      <p class="sublabel">
        <em>Description Search Strings</em>
      </p>
...
<p class="intro">
  There are four panels of filtering options for
...
<p class="intro">
  The <em>Basic Filtering</em> tab allows
  searches for emails based on a variety of criteria:
</p>
<div class="instructions">
  <ul>
    <li>
    ...
    <li>
      <p>
        <span>
          <i>Contact Types</i> limits selected emails
          to those that were sent via batches of that contact type.
        </span>
      </p>
    </li>
    <li>
      <p>
        <span>
          The <i>Date Range</i> limits selected emails to
          those sent within the selected range of time.
        </span>
      </p>
    </li>
    <li>
      <p>
        <span>
          <i>Success</i> allows only successfully sent or
          only failed emails to be selected.
        </span>
      </p>
    </li>
    <li>
      <p>
        <span>
          <i>Flagged</i> allows only flagged or unflagged
          emails to be selected.
        </span>
      </p>
    </li>
    <li>
      <p>
        <span>
          The <i>From Address</i> and <i>To Address</i>
          limits selected email to those that match an entered address.
        </span>
      </p>
    </li>
    <li>
      <p>
        <span>
          The <i>Vote USA User Name</i> limits selected email to
          those that were sent by a batch created by the matching user.
        </span>
      </p>
    </li>
  </ul>
...
<p class="intro">
  Criteria from the <em>Basic Filtering</em> tab
...
<p class="intro">
  ...
  <em>
    Election, Office and
    Candidate Filtering
  </em> tab be sure to select a single state,
...
<div class="instructions">
  <ul>
    <li>
      <p>
        <span>
          All elections for the single jurisdiction will
    ...
    <li>
      <p>
        <span>
          If you select a single election the <i>Offices</i>
          selection will be enabled and you can narrow the filtering
          to one or more offices in the selected election.
        </span>
      </p>
    </li>
    <li>
      <p>
        <span>
          Similarly, if you select a single office the
    ...
    <li>
      <p>
        <span>
          Click <i>Get Logged Emails</i> to display all
          ...
          <i>Contact Type</i> filtering from the
          <em >
            Basic
            Filtering
          </em> tab is applied to the opened emails.
        </span>
      </p>
    </li>
  </ul>
...
<p class="intro">
  The <em>Politician Filtering</em> tab lets you
...
<div class="instructions">
  <ul>
    <li>
      <p>
        <span>
          Enter a last name, or the beginning of a last name,
          ...
          will be moved to the right panel.
        </span>
      </p>
    </li>
    <li>
      <p>
        <span>
          Click <em>Get Logged Emails</em> to display the emails for
          ...
          the <em>Basic Filtering</em> tab is applied to the opened emails.
        </span>
      </p>
      <p>
        <span>
          Double-click a politician in the right panel to
          quickly open emails for just that politician.
        </span>
      </p>
    </li>
  </ul>
...
<p class="intro">
  The <em>Batch Filtering</em> tab works with
...
<div class="instructions">
  <ul>
    <li>
      <p>
        <span>
          Select a list of batches. The <i>Date</i>, <i>Success</i>,
          <i>From Address</i> and <i>User Name</i> filters from the
          <em>
            Basic
            Filtering
          </em> tab are used to determine which batches are
    ...
    <li>
      <p>
        <span>
          Use the checkboxes to choose which batches to
          display the emails for, then click the
          <i>
            Open
            Batches
          </i> Button. Use the Basic Filtering option to
          control whether <i>Success</i>, <i>Flagged</i> and
          <i>To Address</i> filtering from the
          <em>
            Basic
            Filtering
          </em> tab is applied to the opened emails.
      ...
      <p>
        <span>
          Double-click a batch to quickly open emails for
          just that batch.
        </span>
      </p>
    </li>
...
<p class="intro">
  If you want to combine emails from more than
...
<div id="tab-emaillogging-getlogentries">
  ...
  <div class="rounded-border boxed-group maximum-box">
    ...
    <div class="rounded-border control-box">
      <div>
        <input class="maximum-results" type="text" value="1000"/>
      </div>
    </div>
  </div>
  <div class="clear-both"></div>
...
<% if (IsMasterUser)
   { %>
  <div id="tab-emailtypes" class="main-tab content-panel tab-panel htab-panel">
    <div class="inner-panel rounded-border">
      <p class="mainlabel">Use this panel to add Email Types or to change the description for an existing type</p>

      <div class="instructions-page">
        <p class="intro">Select an existing type or <em>&lt;add new type&gt;</em> from the list and click <em>Edit</em></p>
      </div>

      <div class="email-type">
        <p class="mainlabel">Email Type:</p>
        <p>
          <select size="20" runat="server" class="select-email-type-to-edit" id="EditEmailTypeEmailType">
            <option>&lt;no type&gt;</option>
          </select>
        </p>
      </div>
      ...
      <div class="controls">
        <input type="button" value="Edit" class="edit-email-type button-2 button-smallest"/>
      </div>
  ...
  <div id="tab-masteronly" class="main-tab content-panel tab-panel htab-panel">
    <div class="instructions-page">
      <p class="intro">
        These functions are used to maintain the tables that support bulk email for visitors. All except
        <em>Refresh All Districts</em> only process new data and should run fairly quickly.
      </p>
      ...
      <div class="controls">
        <input type="button" value="Remove Malformed Email Addresses" class="remove-malformed-emails button-2 button-smallest"/>
      </div>
      ...
      <p class="intro from-sample-ballot"><em>Transfer from Ballot Choices Log</em> transfers email addresses that were recently entered in the ballot choices dialog to the visitor Addresses table. These entries will already have district coding applied. Last run: <span class="last-run">never</span></p>
      <div class="controls">
        <input type="button" value="Transfer from Ballot Choices Log" class="transfer-from-sample-ballot-log button-2 button-smallest"/>
      </div>
      ...
      <p class="intro refresh-all"><em>Refresh All Districts</em> looks up Tiger district coding for all visitors with geocoding. This is useful after redistricting. This function can be quite time consuming. Last run: <span class="last-run">never</span></p>
      <div class="controls">
        <input type="button" value="Refresh All Districts" class="refresh-all-districts button-2 button-smallest"/>
      </div>
    </div>
  </div>
<% } %>
...
<ul id="batch-filtering-context-menu" class="context-menu">
  <li class="edit rounded-border">
    <div class="icon"></div>
    <div class="text">Change Description</div>
    <div class="clear-both"></div>
  </li>
  <li class="info rounded-border">
    <div class="icon"></div>
...
<ul id="results-context-menu" class="context-menu">
  <li class="view rounded-border">
    <div class="icon"></div>
    <div class="text">View Email</div>
    <div class="clear-both"></div>
  </li>
  <li class="notes rounded-border">
    <div class="icon"></div>
    <div class="text">Notes</div>
    <div class="clear-both"></div>
  </li>
  <li class="flagged rounded-border">
    <div class="icon"></div>
    <div class="text">Flagged</div>
    <div class="clear-both"></div>
  </li>
  <li class="info rounded-border">
    <div class="icon"></div>
  ...
  <li class="batch-description rounded-border">
    <div class="icon"></div>
    <div class="text">Batch Description</div>
    <div class="clear-both"></div>
  </li>
</ul>
  ...
  <div class="inner">
    <div class="top">
      ...
      <table class="info">
        <tbody>
        <tr class="sent">
          <td class="col1">Sent:</td><td class="col2"></td>
        </tr>
        <tr class="from">
          <td class="col1">From:</td><td class="col2"></td>
        </tr>
        <tr class="to">
          <td class="col1">To:</td><td class="col2"></td>
        </tr>
        <tr class="cc">
          <td class="col1">CC:</td><td class="col2"></td>
        </tr>
        <tr class="bcc">
          <td class="col1">BCC:</td><td class="col2"></td>
        </tr>
        <tr class="subject">
          <td class="col1">Subject:</td><td class="col2"></td>
        </tr>
        </tbody>
      </table>
    </div>
...
<div id="filter-by-email-type-dialog" class="hidden">
  <div class="inner">
    <input type="checkbox" class="checkbox"/>Only recipients who
    <div class="radios"><input type="radio" name="email-type-did-or-not" checked="checked" value="did"/>did<br/><input type="radio" name="email-type-did-or-not" value="didnot"/>did not</div>
    receive an email of type <select runat="server" id="EmailTypeDialogEmailType" class="email-type-select"></select>
    <br/>between <input type="text" class="date start-date"/> and <input type="text" class="date end-date"/>
    <div class="buttons">
      <input type="button" value="Ok" class="filter-by-email-type-ok button-1 button-smaller">
    </div>
  </div>
</div>

<div id="filter-by-login-date-dialog" class="hidden">
  <div class="inner">
    <input type="checkbox" class="checkbox"/>Only recipients who
    <div class="radios"><input type="radio" name="login-date-did-or-not" checked="checked" value="did"/>did<br/><input type="radio" name="login-date-did-or-not" value="didnot"/>did not</div>
    log in
    <br/>between <input type="text" class="date start-date"/> and <input type="text" class="date end-date"/>
    <div class="buttons">
      <input type="button" value="Ok" class="filter-by-login-date-ok button-1 button-smaller">
    </div>
  </div>
</div>

<div id="view-recipients-subset-dialog" class="hidden">
  <div class="inner">
    <div class="rounded-border boxed-group subset-box">
      <div class="boxed-group-label">Number to Select</div>
      <div class="rounded-border control-box">
        <div>
          <input class="subset-count" type="text" value="500"/>
        </div>
      </div>
    </div>
    <div class="buttons">
      <input type="button" value="Ok" class="view-recipients-subset-ok button-1 button-smaller">
    </div>
  </div>
</div>

<div id="edit-email-types-dialog" class="hidden">
  <div class="inner">
    <p></p>
    <input type="text" class="email-type-input"/>
    <input type="hidden" class="email-type-key"/>
    <div class="buttons">
      <input type="button" value="Save" class="save-email-type button-1 button-smaller">
    </div>
  </div>
</div>

<div id="embedded-key-dialog" class="hidden">
  <div class="inner">
    <div class="select-state-code select-block" data-type="statecode">
      <div class="item"><label>State Code:</label> <span class="selected-value"></span></div>
      <select id="EmbeddedKeyStates" runat="server">
        <option>&lt;select a state&gt;</option>
      </select>
      <input type="button" value="Insert" disabled="disabled" class="insert-button button-1 button-smallest">
    </div>
    <div class="select-election-key select-block" data-type="electionkey">
      <div class="item"><label>Election Key:</label> <span class="selected-value"></span></div>
      <select disabled="disabled">
        <option>&lt;select an election&gt;</option>
      </select>
      <input type="button" value="Insert" disabled="disabled" class="insert-button button-1 button-smallest">
    </div>
    <div class="select-office-key select-block" data-type="office-key">
      <div class="item"><label>Office Key:</label> <span class="selected-value"></span></div>
      <select disabled="disabled">
        <option>&lt;select an office&gt;</option>
      </select>
      <input type="button" value="Insert" disabled="disabled" class="insert-button button-1 button-smallest">
    </div>
    <div class="select-politician-key select-block" data-type="politiciankey">
      <div class="item"><label>Politician Key:</label> <span class="selected-value"></span></div>
      <select disabled="disabled">
