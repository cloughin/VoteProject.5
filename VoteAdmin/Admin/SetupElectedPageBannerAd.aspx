...
AutoEventWireup="true" CodeBehind="SetupElectedPageBannerAd.aspx.cs" 
Inherits="VoteAdmin.Admin.SetupElectedPageBannerAdPage" %>
        ...
        <div id="ContainerSetupAd" runat="server">
          ...
          <div class="input-element adenabled">
            <div class="databox kalypto-checkbox">
              ...
              <div class="kalypto-checkbox-label">Enable Ad on elected page</div>
          ...
          <div class="delete-button">
            <asp:Button ID="ButtonDeleteAd" EnableViewState="false" 
                        ...
                        Title="Delete this elected page ad" 
          ...
          <div class="update-button">
            <asp:Button ID="ButtonSetupAd" EnableViewState="false" 
                        ...
                        Title="Update the elected page ad setup"
