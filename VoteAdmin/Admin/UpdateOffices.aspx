...
<asp:Content ID="MainContent" ContentPlaceHolderID="MasterMainContent" runat="server">
  ...
  <div id="outer">
    ...
    <user:SelectJurisdictionButton ID="SelectJurisdictionButton" runat="server"
      Tooltip="Update offices for a different state, county or local jurisdiction -- subject to your sign-in credentials."/>
        ...
        <div id="tab-changeinfo" class="main-tab content-panel tab-panel htab-panel">
          ...
          <div id="ContainerChangeInfo" runat="server">
            <div class="inner-panel rounded-border">
              ...
              <hr/>
              <div class="content-area">
                <h6 class="inverted" id="ChangeOfficeInfo" runat="server">Select an office, then click the Edit Office or Delete Office button.</h6>
                ...
                <div class="data-area">
                  ...
                  <input id="DeleteOfficeButton" runat="server" type="button" value="Delete Office" class="changeinfo-delete-button button-3 disabled"/>
                </div>
            ...
            <ContentTemplate>
              <div id="ContainerAddCandidates" runat="server">
                ...
                <div class="inner-panel rounded-border">
                  ...
                  <hr/>
                  <div class="content-area">
                    <h6 class="inverted">Normally incumbents should be set by marking the winners on the <em >General Winners</em> tab of <em >Update Elections</em>. Only use this tab for the following situations:</h6>
                    <div class="instructions">
                      <ul>
                        <li><span>To record an incumbent for an office where we did not cover the election.</span></li>
                        <li><span>To update an incumbent for an office vacancy that was filled by succession or appointment.</span></li>
                      </ul>
                    </div>
                    <div class="clear-both"></div>
                    <hr/>
                ...
                <div class="data-area">
                  ...
                  <div id="master-only-tabs" class="jqueryui-tabs shadow">
                    ...
                    <ul class="htabs unselectable">
                      ...
                      <%-- if (!HideLockClasses)
                         { %>
                          <li class="tab htab" EnableViewState="false" runat="server"><a href="#tab-masteronly-lockclass" onclick="this.blur()" id="A1" EnableViewState="false" runat="server">Lock/Unlock<br />Office Class</a></li>
                      ...
                      <div class="instructions">
                        <ul>
                          <li><span>Use this function to change an office key for the current jurisdiction. When you enter the
                           old and new keys, do not include the jurisdictional prefix (state code, county code and/or local key). All
            ...
            <div class="inner-panel rounded-border">
              ...
              <div class="content-area">
                ...
                <div class="input-element incumbents">
                  ...
                  <div class="databox textbox">
                    <user:TextBoxWithNormalizedLineBreaks spellcheck="false" ID="ControlEditOfficeIncumbents" CssClass="shadow-2 tiptip synced-item incumbents-item" runat="server"
                ...
                <div class="input-element electionpositions">
                  ...
                  <div class="databox textbox">
                    <user:TextBoxWithNormalizedLineBreaks spellcheck="false" ID="ControlEditOfficeElectionPositions" CssClass="shadow-2 tiptip synced-item election-positions-item" runat="server"
                ...
                <div class="input-element primarypositions">
                  ...
                  <div class="databox textbox">
                    <user:TextBoxWithNormalizedLineBreaks spellcheck="false" ID="ControlEditOfficePrimaryPositions" CssClass="shadow-2 tiptip synced-item primary-positions-item" runat="server"
                ...
                <div>
                  ...
                  <div class="col col1">
                    ...
                    <div class="input-element primaryrunoffpositions">
                      ...
                      <div class="databox textbox">
                        <user:TextBoxWithNormalizedLineBreaks spellcheck="false" ID="ControlEditOfficePrimaryRunoffPositions" CssClass="shadow-2 tiptip synced-item" runat="server"
                    ...
                    <div class="input-element generalrunoffpositions">
                      ...
                      <div class="databox textbox">
                        <user:TextBoxWithNormalizedLineBreaks spellcheck="false" ID="ControlEditOfficeGeneralRunoffPositions" CssClass="shadow-2 tiptip synced-item" runat="server"
                    ...
                    <div class="input-element syncpositions">
                      <div class="databox kalypto-checkbox">
                        <div class="kalypto-container">
                          <input id="ControlEditOfficeSyncPositions" class="kalypto mc-nomonitor sync-positions" 
                                 runat="server" type="checkbox" />
                        </div>
                        <div class="kalypto-checkbox-label">Synchronize the five values above</div>
                      </div>
                    </div>
                    ...
                    <div class="input-element isrunningmateoffice">
                      <div class="databox kalypto-checkbox">
                        ...
                        <div class="kalypto-checkbox-label">The candidates for this office have a running mate in general elections</div>
                    ...
                    <div class="input-element isprimaryrunningmateoffice">
                      <div class="databox kalypto-checkbox">
                        <div class="kalypto-container">
                          <input id="ControlEditOfficeIsPrimaryRunningMateOffice" class="kalypto" 
                                 runat="server" type="checkbox" />
                        </div>
                        <div class="kalypto-checkbox-label">The candidates for this office have a running mate in primary elections</div>
                        <div class="tab-ast" id="AsteriskEditOfficeIsPrimaryRunningMateOffice" EnableViewState="false" runat="server"></div>
                      </div>
                    </div>
                  ...
                  <div class="col col2 adrates">
 
                    <div class="input-element primaryadrate">
                      <p class="fieldlabel">Primary Ad Rate</p>
                      <div class="databox textbox">
                        <user:TextBoxWithNormalizedLineBreaks spellcheck="false" ID="ControlEditOfficePrimaryAdRate" CssClass="shadow-2 tiptip primary-adrate-item" runat="server"
                                                              title="Override default ad rate for primary elections."></user:TextBoxWithNormalizedLineBreaks>
                        <div class="tab-ast" id="AsteriskEditOfficePrimaryAdRate" EnableViewState="false" runat="server"></div>
                      </div>
                      <p class="default">Office class default: <span id="PrimaryAdRateDefault" runat="server"></span></p>
                    </div>
 
                    <div class="input-element generaladrate">
                      <p class="fieldlabel">General Ad Rate</p>
                      <div class="databox textbox">
                        <user:TextBoxWithNormalizedLineBreaks spellcheck="false" ID="ControlEditOfficeGeneralAdRate" CssClass="shadow-2 tiptip general-adrate-item" runat="server"
                                                              title="Override default ad rate for general elections."></user:TextBoxWithNormalizedLineBreaks>
                        <div class="tab-ast" id="AsteriskEditOfficeGeneralAdRate" EnableViewState="false" runat="server"></div>
                      </div>
                      <p class="default">Office class default: <span id="GeneralAdRateDefault" runat="server"></span></p>
                    </div>
                  </div>
