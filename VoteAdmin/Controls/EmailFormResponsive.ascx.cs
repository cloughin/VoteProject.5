...
namespace Vote.Controls
{
  public partial class EmailFormResponsive : UserControl
  {
    public class OptionalItem
    {
      ...
      {
        foreach (var item in items)
          item.GetControl().SetValue(string.Empty);
      }
    }
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
      ...
      Page.IncludeJs("https://ajax.googleapis.com/ajax/libs/jqueryui/1.11.4/jquery-ui.min.js");
      Page.IncludeCss(
    ...
    private void AddItem(string text, string value) => EmailFormSubject.AddItem(text, value);
