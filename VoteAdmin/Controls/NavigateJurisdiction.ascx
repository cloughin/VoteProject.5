...
<div id="navigateJurisdiction" class="hidden">
  ...
  <input id="OriginalLocalKey" runat="server" class="local-key" type="hidden" />
  ...
  <div class="outer rounded-border shadow">
    ...
    <input type="button" class="button-2 button-smaller search-all-districts-button disabled" value="Search all districts in state"/>
  </div>
</div>

<div id="searchDistricts" class="hidden">
  <input type="text" placeholder="Enter search text" class="search-districts-text" />
  <p class="instr">Double click to select district</p>
