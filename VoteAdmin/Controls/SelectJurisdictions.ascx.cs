...
namespace Vote.Controls
{
  public partial class SelectJurisdictions : UserControl
  {
    ...
    {
      if (stateCode != null)
        StatesPickerSpecific.InnerText = StateCache.GetStateName(stateCode);
      ...
      else if (localKey == null)
      {
        ...
        CountiesPickerSpecific.InnerText = CountyCache.GetCountyName(stateCode, countyCode);
      ...
      else
      {
        ...
        LocalsPickerSpecific.InnerText =
          LocalDistricts.GetLocalDistrict(stateCode, countyCode, localKey);
        LocalsPickerListButtonContainer.AddCssClasses("hidden");
        BuildLocalsList(stateCode, countyCode, localKey);
      }
    }
