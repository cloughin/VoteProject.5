  ...
  public partial class PoliticiansImagesData
  {
      ...
      int commandTimeout = -1)
    {
      const string cmdText =
        ...
        " FROM PoliticiansImagesData" + " WHERE ProfileOriginalDate > HeadshotDate";
    ...
    public static void GuaranteePoliticianKeyExists(string politicianKey)
    {
      if (!PoliticianKeyExists(politicianKey))
        Insert(
          politicianKey, /*string.Empty,*/ VoteDb.DateTimeMin, /*0, 0,*/
          /*string.Empty,*/ VoteDb.DateTimeMin, /*0, 0,*/ VoteDb.DateTimeMin);
    }
  }
}