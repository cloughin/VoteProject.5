...
namespace DB
{
  namespace VoteCacheLocal
  {
    ...
    public static partial class VoteCacheLocalDb
    {
      ...
      static VoteCacheLocalDb()
      {
        ...
        if (string.IsNullOrWhiteSpace(connectionString))
          connectionString = ConfigurationManager.AppSettings["CnVoteCacheLocal.MySql"];
        if (!string.IsNullOrWhiteSpace(connectionString))
    ...
    public static partial class CacheInvalidation
    {
      ...
      public static Int32 Insert(Int32 id, String transactionType, String cacheKey, DateTime cacheTimeStamp, Boolean isCommonCacheInvalidated)
      {
        return Insert(id, transactionType, cacheKey, cacheTimeStamp, isCommonCacheInvalidated, -1);
      }

      public static Int32 Insert(Int32 id, String transactionType, String cacheKey, DateTime cacheTimeStamp, Boolean isCommonCacheInvalidated, int commandTimeout)
      {
      ...
      public static Int32 Insert(String transactionType, String cacheKey, DateTime cacheTimeStamp, Boolean isCommonCacheInvalidated)
      {
        return Insert(transactionType, cacheKey, cacheTimeStamp, isCommonCacheInvalidated, -1);
      }

      public static Int32 Insert(String transactionType, String cacheKey, DateTime cacheTimeStamp, Boolean isCommonCacheInvalidated, int commandTimeout)
      {
      ...
      public static CacheInvalidationTable GetAllData()
      {
        return GetAllData(-1);
      }

      public static CacheInvalidationTable GetAllData(int commandTimeout)
      {
      ...
      public static void UpdateTable(CacheInvalidationTable table)
      {
        UpdateTable(table, CacheInvalidationTable.ColumnSet.All, -1, ConflictOption.CompareAllSearchableValues, false);
      }

      public static void UpdateTable(CacheInvalidationTable table, CacheInvalidationTable.ColumnSet columnSet)
      {
        UpdateTable(table, columnSet, -1, ConflictOption.CompareAllSearchableValues, false);
      }

      public static void UpdateTable(CacheInvalidationTable table, int commandTimeout)
      {
        UpdateTable(table, CacheInvalidationTable.ColumnSet.All, commandTimeout, ConflictOption.CompareAllSearchableValues, false);
      }

      public static void UpdateTable(CacheInvalidationTable table, CacheInvalidationTable.ColumnSet columnSet, int commandTimeout)
      {
        UpdateTable(table, columnSet, commandTimeout, ConflictOption.CompareAllSearchableValues, false);
      }

      public static void UpdateTable(CacheInvalidationTable table, int commandTimeout, ConflictOption conflictOption, bool continueUpdateOnError)
      {
        UpdateTable(table, CacheInvalidationTable.ColumnSet.All, commandTimeout, conflictOption, continueUpdateOnError);
      }

      public static void UpdateTable(CacheInvalidationTable table, CacheInvalidationTable.ColumnSet columnSet, int commandTimeout, ConflictOption conflictOption, bool continueUpdateOnError)
      {
        using (DbConnection cn = VoteCacheLocalDb.GetOpenConnection())
        {
      ...
      public static String GetTransactionTypeById(Int32 id)
      {
        return GetTransactionTypeById(id, null);
      }

      public static String GetTransactionTypeById(Int32 id, String defaultValue)
      {
        object result;
      ...
      public static String GetCacheKeyById(Int32 id)
      {
        return GetCacheKeyById(id, null);
      }

      public static String GetCacheKeyById(Int32 id, String defaultValue)
      {
        object result;
      ...
      public static CacheInvalidationTable GetDataById(Int32 id)
      {
        return GetDataById(id, -1);
      }

      public static CacheInvalidationTable GetDataById(Int32 id, int commandTimeout)
      {
      ...
      public static int DeleteById(Int32 id, int commandTimeout)
      {
    ...
    public static partial class CachePages
    {
      ...
      public static int DeleteTable(int commandTimeout)
      {
      ...
      public static Int32 Insert(Int32 primaryKey, String pageType, String pageKey, DateTime dateStamp, Byte[] pageImage)
      {
        return Insert(primaryKey, pageType, pageKey, dateStamp, pageImage, -1);
      }

      public static Int32 Insert(Int32 primaryKey, String pageType, String pageKey, DateTime dateStamp, Byte[] pageImage, int commandTimeout)
      {
      ...
      public static Int32 Insert(String pageType, String pageKey, DateTime dateStamp, Byte[] pageImage)
      {
        return Insert(pageType, pageKey, dateStamp, pageImage, -1);
      }

      public static Int32 Insert(String pageType, String pageKey, DateTime dateStamp, Byte[] pageImage, int commandTimeout)
      {
      ...
      public static CachePagesTable GetAllData()
      {
        return GetAllData(-1);
      }

      public static CachePagesTable GetAllData(int commandTimeout)
      {
      ...
      public static void UpdateTable(CachePagesTable table)
      {
        UpdateTable(table, CachePagesTable.ColumnSet.All, -1, ConflictOption.CompareAllSearchableValues, false);
      }

      public static void UpdateTable(CachePagesTable table, CachePagesTable.ColumnSet columnSet)
      {
        UpdateTable(table, columnSet, -1, ConflictOption.CompareAllSearchableValues, false);
      }

      public static void UpdateTable(CachePagesTable table, int commandTimeout)
      {
        UpdateTable(table, CachePagesTable.ColumnSet.All, commandTimeout, ConflictOption.CompareAllSearchableValues, false);
      }

      public static void UpdateTable(CachePagesTable table, CachePagesTable.ColumnSet columnSet, int commandTimeout)
      {
        UpdateTable(table, columnSet, commandTimeout, ConflictOption.CompareAllSearchableValues, false);
      }

      public static void UpdateTable(CachePagesTable table, int commandTimeout, ConflictOption conflictOption, bool continueUpdateOnError)
      {
        UpdateTable(table, CachePagesTable.ColumnSet.All, commandTimeout, conflictOption, continueUpdateOnError);
      }

      public static void UpdateTable(CachePagesTable table, CachePagesTable.ColumnSet columnSet, int commandTimeout, ConflictOption conflictOption, bool continueUpdateOnError)
      {
        using (DbConnection cn = VoteCacheLocalDb.GetOpenConnection())
        {
          string cmdText = GetSelectCommandText(columnSet);
      ...
      public static String GetPageTypeByPrimaryKey(Int32 primaryKey)
      {
        return GetPageTypeByPrimaryKey(primaryKey, null);
      }

      public static String GetPageTypeByPrimaryKey(Int32 primaryKey, String defaultValue)
      {
        object result;
      ...
      public static String GetPageKeyByPrimaryKey(Int32 primaryKey)
      {
        return GetPageKeyByPrimaryKey(primaryKey, null);
      }

      public static String GetPageKeyByPrimaryKey(Int32 primaryKey, String defaultValue)
      {
        object result;
      ...
      public static Byte[] GetPageImageByPrimaryKey(Int32 primaryKey)
      {
        return GetPageImageByPrimaryKey(primaryKey, null);
      }

      public static Byte[] GetPageImageByPrimaryKey(Int32 primaryKey, Byte[] defaultValue)
      {
        object result;
      ...
      public static CachePagesTable GetDataByPrimaryKey(Int32 primaryKey)
      {
        return GetDataByPrimaryKey(primaryKey, -1);
      }

      public static CachePagesTable GetDataByPrimaryKey(Int32 primaryKey, int commandTimeout)
      {
      ...
      public static String GetPageTypeByPageTypePageKey(String pageType, String pageKey)
      {
        return GetPageTypeByPageTypePageKey(pageType, pageKey, null);
      }

      public static String GetPageTypeByPageTypePageKey(String pageType, String pageKey, String defaultValue)
      {
        object result;
      ...
      public static String GetPageKeyByPageTypePageKey(String pageType, String pageKey)
      {
        return GetPageKeyByPageTypePageKey(pageType, pageKey, null);
      }

      public static String GetPageKeyByPageTypePageKey(String pageType, String pageKey, String defaultValue)
      {
        object result;
      ...
      public static Byte[] GetPageImageByPageTypePageKey(String pageType, String pageKey)
      {
        return GetPageImageByPageTypePageKey(pageType, pageKey, null);
      }

      public static Byte[] GetPageImageByPageTypePageKey(String pageType, String pageKey, Byte[] defaultValue)
      {
        object result;
      ...
      public static CachePagesTable GetDataByPageTypePageKey(String pageType, String pageKey)
      {
        return GetDataByPageTypePageKey(pageType, pageKey, -1);
      }

      public static CachePagesTable GetDataByPageTypePageKey(String pageType, String pageKey, int commandTimeout)
      {
      ...
      public static int DeleteByPageTypePageKey(String pageType, String pageKey)
      {
        return DeleteByPageTypePageKey(pageType, pageKey, -1);
      }

      public static int DeleteByPageTypePageKey(String pageType, String pageKey, int commandTimeout)
      {
    ...
    public static partial class DonationNags
    {
      ...
      public static void Insert(Int32 messageNumber, String messageHeading, String messageText, Int32? nextMessageNumber)
      {
        Insert(messageNumber, messageHeading, messageText, nextMessageNumber, -1);
      }

      public static void Insert(Int32 messageNumber, String messageHeading, String messageText, Int32? nextMessageNumber, int commandTimeout)
      {
      ...
      public static DonationNagsTable GetAllData()
      {
        return GetAllData(-1);
      }

      public static DonationNagsTable GetAllData(int commandTimeout)
      {
      ...
      public static void UpdateTable(DonationNagsTable table)
      {
        UpdateTable(table, DonationNagsTable.ColumnSet.All, -1, ConflictOption.CompareAllSearchableValues, false);
      }

      public static void UpdateTable(DonationNagsTable table, DonationNagsTable.ColumnSet columnSet)
      {
        UpdateTable(table, columnSet, -1, ConflictOption.CompareAllSearchableValues, false);
      }

      public static void UpdateTable(DonationNagsTable table, int commandTimeout)
      {
        UpdateTable(table, DonationNagsTable.ColumnSet.All, commandTimeout, ConflictOption.CompareAllSearchableValues, false);
      }

      public static void UpdateTable(DonationNagsTable table, DonationNagsTable.ColumnSet columnSet, int commandTimeout)
      {
        UpdateTable(table, columnSet, commandTimeout, ConflictOption.CompareAllSearchableValues, false);
      }

      public static void UpdateTable(DonationNagsTable table, int commandTimeout, ConflictOption conflictOption, bool continueUpdateOnError)
      {
        UpdateTable(table, DonationNagsTable.ColumnSet.All, commandTimeout, conflictOption, continueUpdateOnError);
      }

      public static void UpdateTable(DonationNagsTable table, DonationNagsTable.ColumnSet columnSet, int commandTimeout, ConflictOption conflictOption, bool continueUpdateOnError)
      {
        using (DbConnection cn = VoteCacheLocalDb.GetOpenConnection())
        {
          string cmdText = GetSelectCommandText(columnSet);
      ...
      public static String GetMessageHeadingByMessageNumber(Int32 messageNumber)
      {
        return GetMessageHeadingByMessageNumber(messageNumber, null);
      }

      public static String GetMessageHeadingByMessageNumber(Int32 messageNumber, String defaultValue)
      {
        object result;
      ...
      public static String GetMessageTextByMessageNumber(Int32 messageNumber)
      {
        return GetMessageTextByMessageNumber(messageNumber, null);
      }

      public static String GetMessageTextByMessageNumber(Int32 messageNumber, String defaultValue)
      {
        object result;
      ...
      public static DonationNagsTable GetDataByMessageNumber(Int32 messageNumber)
      {
        return GetDataByMessageNumber(messageNumber, -1);
      }

      public static DonationNagsTable GetDataByMessageNumber(Int32 messageNumber, int commandTimeout)
      {
      ...
      public static int DeleteByMessageNumber(Int32 messageNumber)
      {
        return DeleteByMessageNumber(messageNumber, -1);
      }

      public static int DeleteByMessageNumber(Int32 messageNumber, int commandTimeout)
      {
    ...
    public static partial class DonationNagsControl
    {
      ...
      public static void Insert(Int32 id, Boolean isNaggingEnabled)
      {
        Insert(id, isNaggingEnabled, -1);
      }

      public static void Insert(Int32 id, Boolean isNaggingEnabled, int commandTimeout)
      {
      ...
      public static DonationNagsControlTable GetAllData()
      {
        return GetAllData(-1);
      }

      public static DonationNagsControlTable GetAllData(int commandTimeout)
      {
      ...
      public static void UpdateTable(DonationNagsControlTable table)
      {
        UpdateTable(table, DonationNagsControlTable.ColumnSet.All, -1, ConflictOption.CompareAllSearchableValues, false);
      }

      public static void UpdateTable(DonationNagsControlTable table, DonationNagsControlTable.ColumnSet columnSet)
      {
        UpdateTable(table, columnSet, -1, ConflictOption.CompareAllSearchableValues, false);
      }

      public static void UpdateTable(DonationNagsControlTable table, int commandTimeout)
      {
        UpdateTable(table, DonationNagsControlTable.ColumnSet.All, commandTimeout, ConflictOption.CompareAllSearchableValues, false);
      }

      public static void UpdateTable(DonationNagsControlTable table, DonationNagsControlTable.ColumnSet columnSet, int commandTimeout)
      {
        UpdateTable(table, columnSet, commandTimeout, ConflictOption.CompareAllSearchableValues, false);
      }

      public static void UpdateTable(DonationNagsControlTable table, int commandTimeout, ConflictOption conflictOption, bool continueUpdateOnError)
      {
        UpdateTable(table, DonationNagsControlTable.ColumnSet.All, commandTimeout, conflictOption, continueUpdateOnError);
      }

      public static void UpdateTable(DonationNagsControlTable table, DonationNagsControlTable.ColumnSet columnSet, int commandTimeout, ConflictOption conflictOption, bool continueUpdateOnError)
      {
        using (DbConnection cn = VoteCacheLocalDb.GetOpenConnection())
        {
          string cmdText = GetSelectCommandText(columnSet);
    ...
    public static partial class LastProcessedId
    {
      ...
      public static void Insert(Int32 id)
      {
        Insert(id, -1);
      }

      public static void Insert(Int32 id, int commandTimeout)
      {
      ...
      public static LastProcessedIdTable GetAllData()
      {
        return GetAllData(-1);
      }

      public static LastProcessedIdTable GetAllData(int commandTimeout)
      {
      ...
      public static void UpdateTable(LastProcessedIdTable table)
      {
        UpdateTable(table, LastProcessedIdTable.ColumnSet.All, -1, ConflictOption.CompareAllSearchableValues, false);
      }

      public static void UpdateTable(LastProcessedIdTable table, LastProcessedIdTable.ColumnSet columnSet)
      {
        UpdateTable(table, columnSet, -1, ConflictOption.CompareAllSearchableValues, false);
      }

      public static void UpdateTable(LastProcessedIdTable table, int commandTimeout)
      {
        UpdateTable(table, LastProcessedIdTable.ColumnSet.All, commandTimeout, ConflictOption.CompareAllSearchableValues, false);
      }

      public static void UpdateTable(LastProcessedIdTable table, LastProcessedIdTable.ColumnSet columnSet, int commandTimeout)
      {
        UpdateTable(table, columnSet, commandTimeout, ConflictOption.CompareAllSearchableValues, false);
      }

      public static void UpdateTable(LastProcessedIdTable table, int commandTimeout, ConflictOption conflictOption, bool continueUpdateOnError)
      {
        UpdateTable(table, LastProcessedIdTable.ColumnSet.All, commandTimeout, conflictOption, continueUpdateOnError);
      }

      public static void UpdateTable(LastProcessedIdTable table, LastProcessedIdTable.ColumnSet columnSet, int commandTimeout, ConflictOption conflictOption, bool continueUpdateOnError)
      {
        using (DbConnection cn = VoteCacheLocalDb.GetOpenConnection())
        {
          string cmdText = GetSelectCommandText(columnSet);
