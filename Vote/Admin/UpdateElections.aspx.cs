...
namespace Vote.Admin
{
  ...
  public partial class UpdateElectionsPage : SecureAdminPage, IAllowEmptyStateCode
  {
    ...
    private ManagePoliticiansPanel _ManagePoliticialsPanel;
    ...
    private string GetElectionKey() => SelectedElectionKey.Value;
    ...
    private void SetElectionHeading(HtmlContainerControl control)
    {
      ...
      var desc = Elections.GetElectionDesc(electionKey, string.Empty);
      if (string.IsNullOrEmpty(desc) && !Elections.IsStateElection(electionKey))
