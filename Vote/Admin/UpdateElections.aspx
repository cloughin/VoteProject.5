...
<asp:Content ID="MainContent" ContentPlaceHolderID="MasterMainContent" runat="server">
  <div id="outer">
    ...
    <div class="sub-heading change-button">
      <input id="ChangeJurisdictionButton" runat="server" type="button" 
          ...
          title="Update the elections for a different state, county or local jurisdiction -- subject to your sign-in credentials."/>
    </div>
   ...
   <%-- if (ShowSendEmailTab) 
     { --%>
          <!--<li class="tab htab" EnableViewState="false" runat="server"><a href="#tab-sendemail" onclick="this.blur()" id="TabSendEmail" EnableViewState="false" runat="server">Send<br />Email</a></li>-->
   <%-- } --%>
            ...
            <div id="ContainerStateDefaults" runat="server">
              ...
              <div class="inner-panel rounded-border">
                ...
                <div class="input-element electionadditionalinfo">
                  ...
                  <p class="fieldlabel sub">This information will be shown in the <em>About This Enhanced Sample Ballot</em> accordion on ballots and on election reports. 
                  ...
                  <div id="ballot-measure-tabs" class="jqueryui-tabs shadow">
                    ...
                    <div id="tab-addballotmeasures-referendumdetail">
                      ...
                      <div class="input-element url detailurl">
                        <div class="databox textbox">
                          <user:TextBoxWithNormalizedLineBreaks spellcheck="false" 
                            ...
                            CssClass="shadow-2 tiptip" title="http:// optional" runat="server"/>
                      ...
                      <div class="icon-box tiptip" title="View the ballot measure detail page">
                        <a class="icon" target="Show" id="IconBoxReferendumDetailUrl" EnableViewState="false" runat="server"></a>
                      </div>
                    ...
                    <div id="tab-addballotmeasures-referendumfulltext">
                      ...
                      <div class="icon-box tiptip" title="View the ballot measure full text page">
                        <a class="icon" target="Show" id="IconBoxReferendumFullTextUrl" EnableViewState="false" runat="server"></a>
                      </div>
  ...
  <%-- if (ShowSendEmailTab) 
     { --%>
        <!--<div id="tab-sendemail" class="main-tab content-panel tab-panel htab-panel">
        </div>-->
  <%-- } --%>
                  ...
                  <div id="master-only-tabs" class="jqueryui-tabs shadow">
                    ...
                    <div id="tab-masteronly-thirdparty">
                      <input type="button" id="voters-edge-button" class="button-2 button-smaller"
                             value="Download Voter&rsquo;s Edge CSV for This Election" />
                      <a class="hidden" id="voters-edge-anchor"></a>
                      <br /><br />
                      <a id="vote-smart-button" class="button-2 button-smaller" href="/Admin/VoteSmartImport.aspx">Go to VoteSmart Import</a>
                    </div>
  ...
  <user:NavigateJurisdiction runat="server" AdminPageName="UpdateElections" />
