...
namespace Vote.Admin
{
  public partial class UpdateElectionsPage
  {
    ...
    private class AddElectionTabItem : ElectionsDataItem
    {
        ...
        // ReSharper restore UnusedMember.Local
      {
        ...
        if (!page.IsPostBack)
        {
          ...
          var statePrimary = page.ControlAddElectionElectionType.Items
            .OfType<ListItem>()
            .FirstOrDefault(i => i.Value == Elections.ElectionTypeStatePrimary);
          if (statePrimary != null)
            statePrimary.Text = "State and/or Presidential Primary";
      ...
      string electionDesc = null)
    {
      ...
      var electionAdditionalInfo = string.Empty;
        //States.GetElectionAdditionalInfo(stateCode).SafeString();
      var ballotInstructions = string.Empty; //States.GetBallotInstructions(stateCode).SafeString();
      ...
      electionsTable.AddRow(electionKey, stateCode, string.Empty, string.Empty,
        ...
        partyCode, string.Empty, electionDesc, electionAdditionalInfo, string.Empty,
        DefaultDbDate, ballotInstructions, false, 0, DefaultDbDate, 0, DefaultDbDate, 0,
