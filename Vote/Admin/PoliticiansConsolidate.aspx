...
<asp:Content ID="MainContent" ContentPlaceHolderID="MasterMainContent" runat="server">
  <asp:UpdatePanel ID="UpdatePanel" runat="server">
    ...
    <table class="tableAdmin" id="TableName" cellspacing="0" cellpadding="0" border="0"
      ...
      <tr>
        <td align="left" class="T">
          Enter any part or parts of the politician’s name in the textboxes provided. When
    ...
    <table class="tableAdmin" id="Table2" cellspacing="0" cellpadding="0" border="0"
      ...
      <tr>
        <td align="left" class="T" >
          ...
          MS SQL treats accented characters like á and à as different characters. MySQL treats
...
&nbsp; </td>
    ...
    <table class="tableAdmin" id="TablePoliticiansHeading" cellspacing="0" cellpadding="0"
      ...
      <tr>
        <td align="left" class="T">
          Click on any of the names in this report to view the politician’s Intro Page.
        </td>
      </tr>
    </table>
    <!-- Table -->
