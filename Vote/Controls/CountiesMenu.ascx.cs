...
namespace Vote.Controls
{
  public partial class CountiesMenuControl : UserControl
  {
    ...
    private void AddCounty(Control block, string countyCode, string countyName)
    {
      ...
      a.HRef = string.Format(_HRefTemplateForFormat, StateCode, countyCode);
      a.Title = countyName;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
      ...
      if (!IsPostBack)
      {
        ...
        else
        {
          ...
          {
            CountiesBlock1, CountiesBlock2, CountiesBlock3, CountiesBlock4,
            CountiesBlock5, CountiesBlock6
          };
          var blockIndex = -1;
