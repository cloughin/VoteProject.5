...
namespace Vote.Controls
{
  public partial class ManagePoliticiansPanel
  {
    ...
    private static IEnumerable<PoliticianUpdateField> GetPoliticianUpdateFields() => 
      new[]
    {
    ...
    private static string FormatAddress(string address, string cityStateZip)
    {
      ...
      string content1, string content2, CategoryOptions options = CategoryOptions.None)
    {
      ...
      var category = new HtmlDiv().AddTo(parent, classNamePrefix + "-databoxes databoxes clearfix",
        true);
    ...
    private void LoadPersonalTab(PoliticiansRow p1, PoliticiansRow p2
      /*, string incumbency1, string incumbency2*/)
    {
      ...
      AnswersTable unselectedAnswers)
    {
      ...
      {
        var responses =
          selectedAnswers.Where(r => r.QuestionKey.IsEqIgnoreCase(row.QuestionKey)).ToList();
    ...
    private static void UpdateImages(string selectedIndex, IDictionary selectedData,
      string selectedKey, PoliticiansImagesDataTable selectedImagesData,
