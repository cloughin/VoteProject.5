...
CodeBehind="Ballot.aspx.cs" Inherits="Vote.BallotPage" %>
...
<asp:Content ID="HeadBottomContent" ContentPlaceHolderID="MasterHeadBottomContent" runat="server">
  <style type="text/css">
    ...
    /* special formatting for single comtest elections */
    body.single-contest .office-cell
    {
      width: 100%;
    }

    body.single-contest .compare-candidates
    {
      display: none;
    }

    body.single-contest .candidate-cell
    {
      width: 33.3333333%;
      display: inline-block;
    }

    body.single-contest .candidate-cell-inner
    {
      border: 1px solid #333;
      margin: 4px;
    }

    body.single-contest .ballot-checks-container a.candidate-checkbox {
      margin-top: 9px;
    }

    body.single-contest .ballot-report .office-cell-inner {
      border: 1px solid #333333;
    }
...
<%--  <script type="text/javascript" src="/js/vote/publicutil.js"></script>--%>
  <script type="text/javascript">
    $(function () {
      if ($("body").data("ad") === "Y")
        PUBLIC.initBannerAd("B", $("body").data("election").substr(0, 2));
    });
  </script>
</asp:Content>
...
<%--      <p class="instructions">Make your choices then select one of these buttons.</p>--%>
      <p class="instructions">Make your choices then select this button.</p>
