<%@ Page ValidateRequest="false" Language="C#" AutoEventWireup="true" CodeBehind="DesignContactUsPage.aspx.cs" Inherits="Vote.Admin.DesignContactUsPage" %>
...
<head id="Head1" runat="server">
  <title>Design for ContactUs.aspx</title>
...
<body>
  <form id="form1" runat="server">
    ...
    <table class="tableAdmin" id="Table1" cellspacing="0" cellpadding="0">
      <tr>
        <td align="left" class="HLarge">
          Design for <span style="color: red">ContactUs.aspx</span> for Design Code:
      ...
      <tr>
        <td align="left" class="T">
          The page elements on this form are only for the Contact Us Page (ContactUs.aspx).</td>
      </tr>
    </table>
    <!-- Table -->
    ...
    <table id="Table6" cellpadding="0" cellspacing="0" class="tableAdmin">
      <tr>
        <td align="left" class="H" valign="top">
          ContactUs Page Title</td>
      </tr>
      <tr>
        <td class="TSmallBorder">
          &lt;tr class="trContactUsPageTitle"&gt;</td>
      </tr>
      <tr>
        <td class="TSmallBorder">
          &lt;td class="tdContactUsPageTitle"&gt;Contact Us&lt;/td&gt;&lt;/tr&gt;&lt;/table&gt;</td>
      </tr>
    </table>
    <!-- Table -->
    <table cellpadding="0" cellspacing="0" class="tableAdmin">
      <tr class="trContactUsPageTitle">
        <td class="tdContactUsPageTitle">
          Contact Us</td>
      </tr>
    </table>
    <!-- Table -->
    <table id="Table3" cellpadding="0" cellspacing="0" class="tableAdmin">
      <tr>
        <td align="left" class="H" valign="top">
          ContactUs Page Content</td>
      </tr>
      <tr>
        <td class="TSmallBorder">
          &lt;table id ="tableContactUsPageContent"&gt;&lt;tr class="trContactUsPageContent"&gt;</td>
      </tr>
      <tr>
        <td class="TSmallBorder">
          &lt;td class="tdContactUsPageContent"&gt;At Vote-USA.org, we feel that American representative
          democracy...&lt;/td&gt;&lt;/tr&gt;&lt;/table&gt;</td>
      </tr>
    </table>
    <!-- Table -->
    <table id="tableContactUsPageContent" cellpadding="0" cellspacing="0" class="tableAdmin">
      <tr class="trContactUsPageContent">
        <td class="tdContactUsPageContent">
          <asp:Label ID="LabelContentContactUs" runat="server"></asp:Label></td>
      </tr>
    </table>
    <!-- Table -->
    <table class="tableAdmin" id="Table" cellspacing="0" cellpadding="0">
      <tr>
        <td align="left" valign="top" class="BorderLight">
          <asp:RadioButtonList ID="RadioButtonListIsTextContentContactUs" runat="server"
            AutoPostBack="True" CssClass="RadioButtons" 
            OnSelectedIndexChanged="RadioButtonListIsTextContentContactUs_SelectedIndexChanged"
    ...
    <table class="tableAdmin" id="Table2" cellspacing="0" cellpadding="0">
      <tr>
        <td align="left">
          <user:TextBoxWithNormalizedLineBreaks ID="TextBoxContentContactUs" runat="server" TextMode="MultiLine" Rows="1"
            Height="400px" Width="930px" CssClass="TextBoxInputMultiLine"></user:TextBoxWithNormalizedLineBreaks></td>
      </tr>
      <tr>
        <td align="left">
          &nbsp;
          <asp:Button ID="ButtonGetDefaultContentContactUs" runat="server" CssClass="Buttons"
            Text="Get Default Design" Width="150px" 
            OnClick="ButtonGetDefaultContentContactUs_Click" />&nbsp; 
          <asp:Button ID="ButtonClearCustomContentContactUs" runat="server" CssClass="Buttons"
            Text="Clear Custom Design" Width="150px" 
            OnClick="ButtonClearCustomContentContactUs_Click" />&nbsp; 
          <asp:Button ID="ButtonSubmitCustomContentContactUs" runat="server" CssClass="Buttons"
            Text="Submit Custom Design" Width="160px" 
            OnClick="ButtonSubmitCustomContentContactUs_Click" /></td>
      </tr>
    </table>
