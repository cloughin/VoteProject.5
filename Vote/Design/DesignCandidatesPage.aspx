<%@ Page ValidateRequest="false" Language="C#" AutoEventWireup="true" CodeBehind="DesignCandidatesPage.aspx.cs" Inherits="Vote.Admin.DesignCandidatesPage" %>
...
<head id="Head1" runat="server">
  <title>Design for ElectionReport.aspx</title>
  <link href="/css/AllAdmin.css" type="text/css" rel="stylesheet" />
  <link href="/css/All.css" type="text/css" rel="stylesheet" />
  <link id="All" type="text/css" rel="stylesheet" runat="server" />
  <link href="/css/Candidates.css" type="text/css" rel="stylesheet" />
...
<body>
  <form id="form1" runat="server">
    ...
    <table class="tableAdmin" id="Table1" cellspacing="0" cellpadding="0">
      <tr>
        <td align="left" class="HLarge">
          Design for <span style="color: red">ElectionReport.aspx</span> for Design Code:
      ...
      <tr>
        <td align="left" class="T">
          The page elements on this form are only for the report page of the candidates in
          an election. (ElectionReport.aspx).</td>
      </tr>
    </table>
    <!-- Table -->
    ...
    <table id="Table6" cellpadding="0" cellspacing="0" class="tableAdmin">
      <tr>
        <td align="left" class="H" valign="top">
          Candidates Page Title</td>
      </tr>
      <tr>
        <td class="TSmallBorder">
          &lt;table id ="tableCandidatesPageTitle"&gt;&lt;tr class="trCandidatesPageTitle"&gt;</td>
      </tr>
      <tr>
        <td class="TSmallBorder">
          &lt;td class="tdCandidatesPageTitle"&gt;Candidates&lt;/td&gt;&lt;/tr&gt;&lt;/table&gt;</td>
      </tr>
    </table>
    <!-- Table -->
    <table id="tableCandidatesPageTitle" cellpadding="0" cellspacing="0" class="tableAdmin">
      <tr class="trCandidatesPageTitle">
        <td class="tdCandidatesPageTitle">
          Candidates</td>
      </tr>
    </table>
    <!-- Table -->
    <table id="Table3" cellpadding="0" cellspacing="0" class="tableAdmin">
      <tr>
        <td align="left" class="H" valign="top">
          Candidates Page Content</td>
      </tr>
      <tr>
        <td class="TSmallBorder">
          &lt;tr class="trCandidatesPageContent"&gt;</td>
      </tr>
      <tr>
        <td class="TSmallBorder">
          &lt;td class="tdCandidatesPageContent"&gt;At Vote-USA.org, we feel that American representative
          democracy...&lt;/td&gt;&lt;/tr&gt;&lt;/table&gt;</td>
      </tr>
    </table>
    <!-- Table -->
    <table cellpadding="0" cellspacing="0" class="tableAdmin">
      <tr class="trCandidatesPageContent">
        <td class="tdCandidatesPageContent">
          <asp:Label ID="LabelContentCandidates" runat="server"></asp:Label></td>
      </tr>
    </table>
    <!-- Table -->
    <table class="tableAdmin" id="Table" cellspacing="0" cellpadding="0">
     <tr>
        <td align="left" valign="top" class="BorderLight">
          <asp:RadioButtonList ID="RadioButtonListIsTextContentCandidates" runat="server"
            AutoPostBack="True" CssClass="RadioButtons" 
            OnSelectedIndexChanged="RadioButtonListIsTextContentCandidates_SelectedIndexChanged"
    ...
    <table class="tableAdmin" id="Table2" cellspacing="0" cellpadding="0">
     <tr>
        <td align="left">
          <user:TextBoxWithNormalizedLineBreaks ID="TextBoxContentCandidates" runat="server" TextMode="MultiLine" Rows="1"
            Height="400px" Width="930px" CssClass="TextBoxInputMultiLine"></user:TextBoxWithNormalizedLineBreaks></td>
      </tr>
      <tr>
        <td align="left">
          &nbsp;
          <asp:Button ID="ButtonGetDefaultContentCandidates" runat="server" CssClass="Buttons"
            Text="Get Default Design" Width="150px" 
            OnClick="ButtonGetDefaultContentCandidates_Click" />&nbsp; &nbsp;<asp:Button ID="ButtonClearCustomContentCandidates" runat="server" CssClass="Buttons"
            Text="Clear Custom Design" Width="150px" 
            OnClick="ButtonClearCustomContentCandidates_Click" />&nbsp; 
          <asp:Button ID="ButtonSubmitCustomContentCandidates" runat="server" CssClass="Buttons"
            Text="Submit Custom Design" Width="160px" 
            OnClick="ButtonSubmitCustomContentCandidates_Click" /></td>
      </tr>
    </table>
