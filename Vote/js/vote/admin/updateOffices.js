  ...
  function ($, master, util, monitor, navigateJurisdiction, officeControl,
   managePoliticiansPanel) {
      ...
      util.ajax({
        ...
        success: function (result) {
          ...
          if (result.d.substr(0, 1) == "*") {
            ...
            util.alert("Office key: " + result.d + "\n\n" +
    ...
    function getSelectedTemplateOfficeLevel() {
      return $("#tab-addofficetemplate input[name='AddOfficeTemplate_Level']:checked").val();
    }
      ...
      util.ajax({
        ...
        success: function (result) {
          ...
          if (result.d.substr(0, 1) == "*") {
            ...
            util.alert("Office key: " + result.d + "\n\n" +
              "Use the Edit dialog that follows to change any defaults.\n" +
              "Just dismiss the dialog if no changes are needed.", "The office template was added");
          }
        },
        ...
        util.ajax({
          ...
          success: function (result) {
            ...
            $("#tab-addofficetemplate .current-template-list-container")
              .toggleClass("hidden", result.d.length === 0);
            $("#tab-addofficetemplate .current-template-list").html(result.d.join("<br />"));
    ...
    function initChangeInfoTab() {
      ...
      $(".changeinfo-delete-button").click(function () {
        ...
        if (getCountyCode() && officeKey.indexOf('#') >= 0) {
          util.alert("This is a virtual office that has not yet been actualized.");
          return;
        }
    ...
    function showOfficeDeleteDialog(info) {
      ...
      processInfo("Politicians.TemporaryOfficeKey", info.InPoliticiansTemporaryOfficeKey);
    ...
    function initPage() {
      ...
      //var queryTab = $.queryString("tab");
      var defaultTab = /*queryTab 
        ? "tab-" + queryTab
        : */(queryOffice ? "tab-changeinfo" : "tab-addoffice");
    ...
    function getLocalCode() {
      return $("#MainForm").data("local-code");
    }
    ...
    function reloadPanel(id, option) {
      ...
      switch (id) {
        ...
        case "tab-changeinfo":
          ...
          $(".changeinfo-delete-button").toggleClass("disabled", !officeControl.getSelectedOffice());
