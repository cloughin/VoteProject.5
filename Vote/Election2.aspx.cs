...
namespace Vote
{
  public partial class Election2Page : CacheablePage
  {
    ...
    {
      return
        $"{UrlManager.GetStateCodeFromHostName()}.{QueryState}.{QueryElection}." + $"{GetQueryString("openall").IsEqIgnoreCase("Y")}";
    }
    ...
    {
      var report = Election2ReportResponsive.GetReport(_ElectionKey);
