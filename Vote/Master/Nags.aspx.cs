...
namespace Vote.Master
{
  public partial class NagsPage : SecurePage, ISuperUser
  {
    ...
    private int GetMsgNoFromForm()
    {
      ...
      var tbMessageNumber =
        Master.FindMainContentControl(TextBoxMessageNumberId) as TextBox;
      return NagFeedback.ValidateInt(tbMessageNumber, out success, "MsgNo", 1);
    }
    ...
    private string GetMsgTextFromForm()
    {
      ...
      return NagFeedback.ValidateRequired(tbMessageText, "Message text", out success);
    }
    ...
    private int? GetNextMsgFromForm()
    {
      ...
      var nextMsgNo = NagFeedback.ValidateIntOptional(
        tbNextMessageNumber, out success, "NextMsg", 0, 1);
    ...
    private void BuildHtmlTable()
    {
      ...
      // possible modes: normal (string.Empty), "Edit", "Insert"
      ...
      DonationNagsRow nagsRow)
    {
      ...
      if ((editMode == "Edit") && (editMessageNumber == nagsRow.MessageNumber))
      {
        ...
        tbMessageText.Text = string.IsNullOrWhiteSpace(nagsRow.MessageText)
          ? string.Empty
          : nagsRow.MessageText;
      }
      ...
      else
      {
        ...
        p.InnerHtml = string.IsNullOrWhiteSpace(nagsRow.MessageText)
          ? "&nbsp;"
          : nagsRow.MessageText;
      }
    }
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
      if (!IsPostBack)
      {
        Page.Title = "Donation Nags and Sample Ballot Request Dialogs Control";
        H1.InnerHtml = "Donation Nags and Sample Ballot Request Dialogs Control";
    ...
    private void AddButton_Click(object sender, EventArgs e)
    {
      ...
      try
      {
        ...
        NagEditMode.Value = string.Empty;
        BuildHtmlTable();
      }
      catch (Exception ex)
      {
      ...
      object sender, EventArgs e)
    {
      try
      {
        ...
        if (SampleBallotControl.SelectedValue == "T")
        {
          ...
          msg =
            "The 'Get Future Sample Ballots Automatically' Dialog has been ENABLED.";
        }
        else
        {
          DB.Vote.Master.UpdatePresentGetFutureSampleBallotsDialog(false);
          msg =
            "The 'Get Future Sample Ballots Automatically' Dialog has been DISABLED.";
        }
