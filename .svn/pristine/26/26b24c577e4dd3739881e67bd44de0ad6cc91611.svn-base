<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="forPartners.aspx.cs" Inherits="VoteNew.forPartners" %>
...
<head id="Head1" runat="server">
  <title runat="server" id="TitleTag" >For Partners - VoteUSA.org</title>
</head>
<body>
    ...
    <div id="container">
      ...
      <div id="mainContent">
        <div class="header">
          <img src="/images/forpartnerstitle.png" alt="For Partners" />
        </div>
