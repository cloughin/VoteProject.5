<%@ Page ValidateRequest="false" Language="C#" AutoEventWireup="true" CodeBehind="DesignElectedPage.aspx.cs" Inherits="Vote.Admin.DesignElectedPage" %>
...
<head id="Head1" runat="server">
  <title>Design for Elected.aspx</title>
...
<body>
  <form id="form1" runat="server">
    ...
    <table class="tableAdmin" id="Table1" cellspacing="0" cellpadding="0">
      <tr>
        <td align="left" class="HLarge">
          Design for <span style="color: red">Elected.aspx</span> for Design Code:
      ...
      <tr>
        <td align="left" class="T">
          The page elements on this form are only for the Elected Officials Page (Elected.aspx).</td>
      </tr>
    </table>
    <!-- Table -->
      ...
      <tr>
        <td align="left" valign="top" class="BorderLight">
          <asp:RadioButtonList ID="RadioButtonListIsTextInstructionsElected" runat="server"
            ...
            OnSelectedIndexChanged="RadioButtonListIsTextInstructionsElected_SelectedIndexChanged"
    ...
    <table class="tableAdmin" id="Table2" cellspacing="0" cellpadding="0">
      <tr>
        <td align="left">
          <user:TextBoxWithNormalizedLineBreaks ID="TextBoxInstructionsElected" runat="server" TextMode="MultiLine" Rows="1"
            Height="150px" Width="930px" CssClass="TextBoxInputMultiLine"></user:TextBoxWithNormalizedLineBreaks></td>
      </tr>
      <tr>
        <td align="left">
          &nbsp;
          <asp:Button ID="ButtonGetDefaultInstructionsElected" runat="server" CssClass="Buttons"
            Text="Get Default Design" Width="150px" 
            OnClick="ButtonGetDefaultInstructionsElected_Click" />&nbsp; &nbsp;
          <asp:Button ID="ButtonClearCustomInstructionsElected" runat="server" CssClass="Buttons"
            Text="Clear Custom Design" Width="150px" 
            OnClick="ButtonClearCustomInstructionsElected_Click" />&nbsp; &nbsp;
          <asp:Button ID="ButtonSubmitCustomInstructionsElected" runat="server" CssClass="Buttons"
            Text="Submit Custom Design" Width="160px" 
            OnClick="ButtonSubmitCustomInstructionsElected_Click" /></td>
      </tr>
    </table>
    <!-- Table -->
    <table id="Table10" cellpadding="0" cellspacing="0" class="tableAdmin">
      ...
      <tr>
        <td choff="<" class="TSmallBorder">
          &lt;tr class="tdReportDetail"&gt;&lt;td Class="tdReportDetail"&gt;&lt;a
          ... &gt;George...&lt;/td&gt;</td>
      </tr>
      <tr>
        <td choff="<" class="TSmallBorder">
      ...
      <tr>
        <td>
          <user:TextBoxWithNormalizedLineBreaks ID="TextBoxDefaultStyleSheet" runat="server" TextMode="MultiLine" 
            ReadOnly="True" Width="350px" Height="2000px" CssClass="TextBoxInputMultiLine"></user:TextBoxWithNormalizedLineBreaks>
        </td>
        <td>
          <user:TextBoxWithNormalizedLineBreaks ID="TextBoxCustomStyleSheet" runat="server"  Height="2000px"
