<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="forStateElectionAuthorities.aspx.cs" Inherits="VoteNew.forStateElectionAuthorities" %>
...
<head id="Head1" runat="server">
  <title runat="server" id="TitleTag" >For State Election Authorities - VoteUSA.org</title>
</head>
<body>
    ...
    <div id="container">
      ...
      <div id="mainContent">
        <div class="header">
          <img src="/images/forstateelectionauthoritiestitle.png" alt="For State Election Authorities" />
        </div>

        <!--<div class="intro">Every candidate on this website was invited to provide his or her picture and 
