define(["jquery", "vote/util"], function($, util) {
  ...
  function ElectionsOfficesCandidates($control, options) {
    ...
    this.onCandidatesGetListClick = function (event) {
    ...
    this.onElectionsGetListClick = function (event) {
    ...
    this.onOfficesGetListClick = function (event) {
    ...
    this.setJurisdiction = function (stateCode,
      ...
      if (stateCode !== jurisdiction.stateCode ||
        ...
        localCode !== jurisdiction.localCode) {
        if (!stateCode) countyCode = "";
        if (!countyCode) localCode = "";
        jurisdiction = {
          stateCode: stateCode,
          countyCode: countyCode,
          localCode: localCode
