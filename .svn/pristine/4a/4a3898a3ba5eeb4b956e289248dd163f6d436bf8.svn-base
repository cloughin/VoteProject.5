<%@ Page ValidateRequest="false" Language="C#" AutoEventWireup="true" CodeBehind="NotesView.aspx.cs" 
Inherits="Vote.Master.NotesView" %>
...
<head runat="server">
    ...
    <!-- Table -->
            ...
            &nbsp;These are all the notes recorded for this State.</TD>
				</TR>
				<TR>
					<TD vAlign="middle" align="left" class="T">
						<asp:Label id="LabelNotes" runat="server" CssClass="TSmall"></asp:Label></TD>
				</TR>
				<TR>
